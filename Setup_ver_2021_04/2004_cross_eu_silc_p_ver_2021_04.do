* 2004_cross_eu_silc_p_ver_2021_04.do 
* 2nd update
*
...
* 
* EU-SILC Cross 2004 - release 2021-04 / DOI: https://doi.org/10.2907/EUSILC2004-2019V.2
*
...
*
* Pforr, Klaus and Johanna Jung (2021): 2004_cross_eu_silc_p_ver_2021_04.do, 2nd update.
...
foreach CC in AT BE DK EE EL ES FI FR IE IS IT LU NO PT SE { ;
	...
	import delimited using "UDB_c`CC'04P.csv", case(upper) clear ;
