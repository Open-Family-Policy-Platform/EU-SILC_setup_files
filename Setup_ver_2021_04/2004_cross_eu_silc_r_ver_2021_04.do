* 2004_cross_eu_silc_r_ver_2021_04.do 
* 2nd update
*
...
*
* Pforr, Klaus and Johanna Jung (2021): 2004_cross_eu_silc_r_ver_2021_04.do, 2nd update.
...
foreach CC in AT BE DK EE EL ES FI FR IE IS IT LU NO PT SE { ;
	...
	import delimited using "UDB_c`CC'04R.csv", case(upper) clear ;
