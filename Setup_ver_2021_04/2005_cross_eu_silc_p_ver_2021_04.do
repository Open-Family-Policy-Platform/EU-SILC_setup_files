* 2005_cross_eu_silc_p_ver_2021_04.do 
* 2nd update
*
...
* 
* EU-SILC Cross 2005 - release 2021-04 / DOI: https://doi.org/10.2907/EUSILC2004-2019V.2
*
...
*
* Pforr, Klaus and Johanna Jung (2021): 2005_cross_eu_silc_p_ver_2021_04.do, 2nd update.
...
local log_file "$log/eusilc_2005_p" ;
...
local stata_file "$log/eusilc_2005_p_cs" ;
...
foreach CC in AT BE CY CZ DE DK EE EL ES FI FR HU IE IS IT LT LU LV NL NO PL PT SE SI SK UK { ;
	...
	import delimited using "UDB_c`CC'05P.csv", case(upper) clear ;
...
label variable PB020 "Country alphanumerical" ;
...
label variable PB210 "Country of birth alphanumerical" ;
label variable PB210_num "Country of birth numerical" ;
label variable PB210_F "Flag" ;
label variable PB220A "Citizenship 1 alphanumerical" ;
label variable PB220A_num "Citizenship 1 numerical" ;
...
label variable PL110_num "NACE numerical (Rev.1.1)" ;
...
label variable PM005 "Personal intergenerational cross-sectional weight" ;
label variable PM005_F "Flag" ;
label variable PM010 "Main family composition" ;
label variable PM010_F "Flag" ;
label variable PM020 "Year of birth of father" ;
label variable PM020_F "Flag" ;
label variable PM030 "Year of birth of mother" ;
label variable PM030_F "Flag" ;
label variable PM035 "Main Number of siblings" ;
label variable PM035_F "Flag" ;
label variable PM040 "Highest ISCED level of education attained by father" ;
label variable PM040_F "Flag" ;
label variable PM050 "Highest ISCED level of education attained by mother" ;
label variable PM050_F "Flag" ;
label variable PM060 "Main activity status of father" ;
label variable PM060_F "Flag" ;
label variable PM070 "Main occupation of father" ;
label variable PM070_F "Flag" ;
label variable PM080 "Main activity status of mother" ;
label variable PM080_F  "Flag" ;
label variable PM090 "Main occupation of mother" ;
label variable PM090_F "Flag" ;
label variable PM100 "Financial problems in household when young teenager (DE,EL,PT:information not provided" ;
label variable PM100_F "Flag" ;
...
label define PY200G_F_VALUE_LABELS             
           ...
           -2 "na"
              ; 
label define PM010_VALUE_LABELS               
           1 "Lived with both parents"
           2 "Lived with single mother (single parent family)"
           3 "Lived with single father (single parent family)"
           4 "Lived with mother and mothers new partnerhusband"
           5 "Lived with father and fathers new partnerwife"
           6 "Lived in another private household, foster -home"
           7 "Lived in a collective household or institution"
            ;
label define PM010_F_VALUE_LABELS            
          -5 "not in age range (25-65)"
          -3 "not selected respondent"
          -1 "missing"
           1 "filled"
            ;
label define PM020_VALUE_LABELS            
         1925 "persons born in 1925 or before"
         1958 "persons born in 1958 or after"
          ;
label define PM020_F_VALUE_LABELS           
          -5 "not in age range (25-65)"
          -3 "not selected respondent"
          -2 "NA (no father)"
          -1 "missing"
           1 "filled"
            ;
label define PM030_VALUE_LABELS            
         1925 "persons born in 1925 or before"
         1958 "persons born in 1958 or after"
          ;
label define PM030_F_VALUE_LABELS            
          -5 "not in age range (25-65)"
          -3 "not selected respondent"
          -2 "NA (no mother)"
          -1 "missing"
           1 "filled"
            ;
label define PM035_VALUE_LABELS             
          10 "SI: 10 or more siblings"
              ;
label define PM035_F_VALUE_LABELS           
          -5 "not in age range (25-65)"
          -3 "not selected respondent"
          -1 "missing"
           1 "filled"
        ;
label define PM040_VALUE_LABELS               
           0 "Less than primary education"
           1 "Primary education"
           2 "Lower secondary education"
           3 "Upper secondary education"
           4 "Post-secondary non -tertiary education"
           5 "1st and 2nd stage of tertiary education (grouping of 5 & 6 isced levels)"
            ;
label define PM040_F_VALUE_LABELS            
          -5 "not in age range (25-65)"
          -3 "not selected respondent"
          -2 "NA (no father)"
          -1 "missing"
           1 "filled"
            ;
label define PM050_VALUE_LABELS               
           0 "Less than primary education"
           1 "Primary education"
           2 "Lower secondary education"
           3 "Upper secondary education"
           ...
           5 "1st and 2nd stage of tertiary education (grouping of 5 & 6 isced levels)"
            ;
label define PM050_F_VALUE_LABELS            
          -5 "not in age range (25-65)"
          -3 "not selected respondent"
          -2 "NA (no mother)"
          -1 "missing"
           1 "filled" 
           ;
label define PM060_VALUE_LABELS               
           1 "Employee"
           2 "Self-employed"
           ...
           7 "Other"
            ;
label define PM060_F_VALUE_LABELS            
          -5 "not in age range (25-65)"
          -3 "not selected respondent"
          -2 "NA (no father)"
          -1 "missing"
           1 "filled"
            ;
label define PM070_VALUE_LABELS              
           11 "Legislators, senior officials and managers"
           12 "corporate managers: only for PT, codes 11 & 12 grouped into 13"
           13 "managers of small enterprises: only for PT, codes 11 & 12 grouped into 13"
           21 "physical, mathematical and engineering professionals"
           ...
           01 "armed forces"
            ;
label define PM070_F_VALUE_LABELS            
          -5 "not in age range (25-65)"
          -3 "not selected respondent"
          -2 "NA (no father)"
          -1 "missing"
           1 "filled"
            ;
label define PM080_VALUE_LABELS               
           1 "Employee"
           2 "Self-employed"
           3 "Unpaid family-worker"
           4 "Unemployed"
           ...
           7 "Other"
            ;
label define PM080_F_VALUE_LABELS            
          -5 "not in age range (25-65)"
          -3 "not selected respondent"
          -2 "NA (no mother)"
          -1 "missing"
           1 "filled"
            ;
label define PM090_VALUE_LABELS              
           11 "Legislators, senior officials and managers"
           12 "corporate managers: only for PT, codes 11 & 12 grouped into 13"
           13 "managers of small enterprises: only for PT, codes 11 & 12 grouped into 13"
           21 "physical, mathematical and engineering professionals"
           ...
           01 "armed forces"
              ;
label define PM090_F_VALUE_LABELS            
          -5 "not in age range (25-65)"
          -3 "not selected respondent"
          -2 "NA (no mother)"
          -1 "missing"
           1 "filled"
            ;
label define PM100_VALUE_LABELS              
           1 "Most of the time"
           2 "Often"
           3 "Occasionally"
           4 "Rarely"
           5 "Never"
            ;
label define PM100_F_VALUE_LABELS            
          -5 "not in age range (25-65)"
          -3 "not selected respondent"
          -2 "NA (lived in a collective household or institution)"
          -1 "missing"
           1 "filled"
            ;
...
label values PB220A_F PB210A_F_VALUE_LABELS ;
...
label values PM010 PM010_VALUE_LABELS ;
label values PM010_F PM010F_VALUE_LABELS ;
label values PM020 PM020_VALUE_LABELS ;
label values PM020_F PM020F_VALUE_LABELS ;
label values PM030 PM030_VALUE_LABELS ;
label values PM030_F PM030F_VALUE_LABELS ;
label values PM035 PM035_VALUE_LABELS ;
label values PM035_F PM035F_VALUE_LABELS ;
label values PM040 PM040_VALUE_LABELS ;
label values PM040_F PM040F_VALUE_LABELS ;
label values PM050 PM050_VALUE_LABELS ;
label values PM050_F PM050F_VALUE_LABELS ;
label values PM060 PM060_VALUE_LABELS ;
label values PM060_F PM060F_VALUE_LABELS ;
label values PM070 PM070_VALUE_LABELS ;
label values PM070_F PM070F_VALUE_LABELS ;
label values PM080 PM080_VALUE_LABELS ;
label values PM080_F PM080F_VALUE_LABELS ;
label values PM090 PM090_VALUE_LABELS ;
label values PM090_F PM090F_VALUE_LABELS ;
label values PM100 PM100_VALUE_LABELS ;
label values PM100_F PM100F_VALUE_LABELS ;
label values PX020 PX020_VALUE_LABELS ;
label values PX040 PX040_VALUE_LABELS ;
label values PX050 PX050_VALUE_LABELS ;

label data "Personal data file 2005" ;
