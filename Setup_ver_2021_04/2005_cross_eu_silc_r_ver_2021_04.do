* 2005_cross_eu_silc_r_ver_2021_04.do 
* 2nd update
*
...
*
* Pforr, Klaus and Johanna Jung (2021): 2005_cross_eu_silc_r_ver_2021_04.do, 2nd update.
...
foreach CC in AT BE CY CZ DE DK EE EL ES FI FR HU IE IS IT LT LU LV NL NO PL PT SE SI SK UK { ;
	...
	import delimited using "UDB_c`CC'05R.csv", case(upper) clear ;
