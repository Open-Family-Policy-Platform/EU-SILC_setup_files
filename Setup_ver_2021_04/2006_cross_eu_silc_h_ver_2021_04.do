* 2006_cross_eu_silc_h_ver_2021_04.do 
* 2nd update
*
...
*
* Pforr, Klaus and Johanna Jung (2021): 2006_cross_eu_silc_h_ver_2021_04.do, 2nd update.
...
local stata_file "$log/eusilc_2006_h_cs" ;
...
foreach CC in AT BE CY CZ DE DK EE EL ES FI FR HU IE IS IT LT LU LV NL NO PL PT SE SI SK UK { ;
	...
	import delimited using "UDB_c`CC'06H.csv", case(upper) clear ;
...
label data "Household data file 2006" ;
