* 2006_cross_eu_silc_p_ver_2021_04.do 
* 2nd update
*
...
* 
* EU-SILC Cross 2006 - release 2021-04 / DOI: https://doi.org/10.2907/EUSILC2004-2019V.2
*
...
* Country files are delivered in the format UDB_c*country_stub*06D.csv
* 
* (c) GESIS 2021-11-17
*
* PLEASE NOTE
...
* C-2006 DIFFERENCES BETWEEN DATA COLLECTED.doc	
* 
...
*
* Pforr, Klaus and Johanna Jung (2021): 2006_cross_eu_silc_p_ver_2021_04.do, 2nd update.
...
local log_file "$log/eusilc_2006_p" ;
...
local stata_file "$log/eusilc_2006_p_cs" ;
...
foreach CC in AT BE CY CZ DE DK EE EL ES FI FR HU IE IS IT LT LU LV NL NO PL PT SE SI SK UK { ;
	...
	import delimited using "UDB_c`CC'06P.csv", case(upper) clear ;
...
label variable PS005 "Personal cross-sectional weight" ;
label variable PS005_F "Flag (not described in var. description)" ;
label variable PS010 "Number of times going to the cinema" ;
label variable PS010_F "Flag" ;
label variable PS020 "Number of times going to live performances (plays, concerts,operas, ballet and dance)" ;
label variable PS020_F "Flag" ;
label variable PS030 "Number of visits to cultural sites" ;
label variable PS030_F "Flag" ;
label variable PS040 "Number of times attending sport events" ;
label variable PS040_F "Flag" ;
label variable PS050 "Frequency of getting toghether with relatives" ;
label variable PS050_F "Flag" ;
label variable PS060 "Frequency of getting together with friends" ;
label variable PS060_F "Flag" ;
label variable PS070 "Frequency of contacts with relatives" ;
label variable PS070_F "Flag" ;
label variable PS080 "Frequency of contacts with friends" ;
label variable PS080_F "Flag" ;
label variable PS090 "Ability to ask any relative, friend or neighbour for help" ;
...
label variable PS110 "Participation in activities of political parties or trade unions" ;
label variable PS110_F "Flag" ;
label variable PS120 "Participation in activities of professional organisations" ;
label variable PS120_F "Flag" ;
label variable PS130 "Participation in activities of churches or other religious organisations" ;
label variable PS130_F "Flag" ;
label variable PS140 "Participation in activities of recreational groups or organisations" ;
label variable PS140_F "Flag" ;
label variable PS150 "Participation in activities of charitable organisations" ;
label variable PS150_F "Flag" ;
label variable PS160 "Participation in activities of other groups or organisations" ;
label variable PS160_F "Flag" ;
...
label variable PL110_num "NACE (Rev.1.1)numeric" ;
...
label define PY200G_F_VALUE_LABELS             
           ...
           -2 "na" 
            ;
label define PS005_F_VALUE_LABELS             
            1 "filled ??"
           -3 "not selected respondent ???"
            ;
...
label define PS020_VALUE_LABELS               
            ...
            3 "4-6 times"
            4 "7-12 times"
            5 "more than twelve times"
            ;
label define PS020_F_VALUE_LABELS            
            -3 "not selected respondent"
           	-1 "missing"
            1 "variable is filled"
            ;
label define PS030_VALUE_LABELS               
            ...
            5 "more than 12 times"
            ;
label define PS030_F_VALUE_LABELS            
           -3 "not selected respondent"
           -1 "missing"
            1 "variable is filled"
            ;
label define PS040_VALUE_LABELS               
            ...
            5 "more than 12 times"
            ;
label define PS040_F_VALUE_LABELS            
           -3 "not selected respondent"
           -1 "missing"
            1 "variable is filled"
            ;
...
label define PS110_F_VALUE_LABELS            
           ...
           -1 "missing"
            1 "variable is filled"
            ;
label define PS120_VALUE_LABELS               
            1 "Yes"
            2 "No"
            ;
label define PS120_F_VALUE_LABELS            
           -3 "not selected respondent"
           -1 "missing"
            1 "variable is filled"
            ;
label define PS130_VALUE_LABELS               
            1 "Yes"
            2 "No"
            ;
label define PS130_F_VALUE_LABELS            
           -1 "missing"
            1 "variable is filled"
            ;
label define PS140_VALUE_LABELS              
            1 "Yes"
            2 "No"
            ;
label define PS140_F_VALUE_LABELS            
           -3 "not selected respondent"
           -1 "missing"
            1 "variable is filled"
            ;
label define PS150_VALUE_LABELS               
            1 "Yes"
            2 "No"
            ;
label define PS150_F_VALUE_LABELS            
           -3 "not selected respondent"
           -1 "missing"
            1 "variable is filled"
            ;
label define PS160_VALUE_LABELS               
            1 "Yes"
            2 "No"
            ;
label define PS160_F_VALUE_LABELS            
           -3 "not selected respondent"
           -1 "missing"
            1 "variable is filled"
            ;
...
label values PS005_F PS005_F_VALUE_LABELS ;
label values PS010 PS010_VALUE_LABELS ; 
label values PS010_F PS010_F_VALUE_LABELS ; 
label values PS020 PS020_VALUE_LABELS ; 
label values PS020_F PS020_F_VALUE_LABELS ; 
label values PS030 PS030_VALUE_LABELS ; 
label values PS030_F PS030_F_VALUE_LABELS ; 
label values PS040 PS040_VALUE_LABELS ; 
label values PS040_F PS040_F_VALUE_LABELS ; 
...
label values PS110_F PS110_F_VALUE_LABELS ; 
label values PS120 PS120_VALUE_LABELS ; 
label values PS120_F PS120_F_VALUE_LABELS ; 
label values PS130 PS130_VALUE_LABELS ; 
label values PS130_F PS130_F_VALUE_LABELS ; 
label values PS140 PS140_VALUE_LABELS ; 
label values PS140_F PS140_F_VALUE_LABELS ; 
label values PS150 PS150_VALUE_LABELS ; 
label values PS150_F PS150_F_VALUE_LABELS ; 
label values PS160 PS160_VALUE_LABELS ; 
label values PS160_F PS160_F_VALUE_LABELS ; 
...
label data "Personal data file 2006" ;
