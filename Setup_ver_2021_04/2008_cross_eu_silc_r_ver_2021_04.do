* 2008_cross_eu_silc_r_ver_2021_04.do 
* 2nd update
*
...
*
* Pforr, Klaus and Johanna Jung (2021): 2008_cross_eu_silc_r_ver_2021_04.do, 2nd update.
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HU IE IS IT LT LU LV MT NL NO PL PT RO SE SI SK UK { ;
      cd "$csv_path/`CC'/2008" ;
	  import delimited using "UDB_c`CC'08R.csv", case(upper) clear ;
...
label variable RB240 "SpousePartner ID" ;
...
label variable RL010 "Education at pre-school: number of hours of education during an usual week (Missing:CH)" ;
label variable RL010_F "Flag" ;
label variable RL020 "Education at compulsory school: number of hours of education during an usual week (Missing:CH)" ;
label variable RL020_F "Flag" ;
label variable RL030 "Childcare at centre-based services: number of hours of child care during an usual week (Missing:CH)" ;
label variable RL030_F "Flag" ;
label variable RL040 "Childcare at day-care centre: number of hours of child care during an usual week (Missing:CH)" ;
label variable RL040_F "Flag" ;
label variable RL050 "Child care by a professional child-miner: number of hours of child care during an usual week (Missing:CH)" ;
label variable RL050_F "Flag" ;
label variable RL060 "Child care by grand-parents;other household members;relatives etc: number of hours during an usual week (Missing:CH)" ;
