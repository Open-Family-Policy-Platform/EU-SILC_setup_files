* 2009_cross_eu_silc_h_ver_2021_04.do 
* 2nd update
*
...
*
* Pforr, Klaus and Johanna Jung (2021): 2009_cross_eu_silc_h_ver_2021_04.do, 2nd update.
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HU IE IS IT LT LU LV MT NL NO PL PT RO SE SI SK UK { ;
      cd "$csv_path/`CC'/2009" ;
	   import delimited using "UDB_c`CC'09H.csv", case(upper) clear ;
...
label variable HD050 "Damaged public amenities (bus stops, lamp posts, pavements, etc.) in the neighbourhood" ;
...
label variable HD140 "One mealwith meat, chickenor fish (or vegetarian equivalant) at least once a day" ;
...
label variable HD210 "participate in school trips and school eventsthat cost money" ;  
...
label variable HD250 "unmet need for consulting a gp or specialist, excluding dentists a and ophthalmologists" ;
label variable HD250_F "Flag" ;
label variable HD255 "main reason for unmet need for consulting a gp or specialist, excluding dentists a and ophthalmologists" ;
