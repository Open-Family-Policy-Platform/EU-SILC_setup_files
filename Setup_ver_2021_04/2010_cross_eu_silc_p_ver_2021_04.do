* 2010_cross_eu_silc_p_ver_2021_04.do 
* 2nd update
*
...
* 
* EU-SILC Cross 2010 - release 2021-04 / DOI: https://doi.org/10.2907/EUSILC2004-2019V.2 
*
...
*
* Pforr, Klaus and Johanna Jung (2021): 2010_cross_eu_silc_p_ver_2021_04.do, 2nd update.
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO SE SI SK UK { ;
      cd "$csv_path/`CC'/2010" ;		
	if "`CC'"!="IT" {;	  
	  import delimited using "UDB_c`CC'10P.csv", case(upper) clear ;
	};
	if "`CC'"=="IT" {;
		import delimited using "udb_cit10p_release_17-09.csv", case(upper) clear ;
	};
...
* Definition of variable labels ;
label variable PA010 "Proportion of personal income kept separate from the common household budget" ;
...
label variable PA050 "Decicion-making on expensive purchases of consumer durables and furniture" ;
label variable PA050_F "Flag" ;
label variable PA060 "Desicion-making on borrowing money" ;
...
label variable PA090 "Ability to decide about expenses for your own personal consumption, your leisure activities and hobbies" ;
label variable PA090_F "Flag" ;
label variable PA100 "Ability to decide about purchases for children's needs (including giving them pocket money)" ;
label variable PA100_F "Flag" ;
label variable PA110 "Length of cohabitation of the partners" ;
label variable PA110_F "Flag" ;
label variable PA120 "Time spent commuting to and from work" ;
label variable PA120_F "Flag" ;
label variable PA130 "Time spent on Leisure" ;
label variable PA130_F "Flag" ;
label variable PA140 "Time spent on household work, child care and for other dependants" ;
label variable PA140_F "Flag" ;
label variable PA150 "Money spent per month for own use" ;
label variable PA150_F "Flag" ;
label variable PA160 "Money spent per month for children by the interviewed person" ;
...
label variable PL110 "NACE (Rev.1.1), see also PL110_num" ;
label variable PL110_F "Flag" ; 
label variable PL110_num "NACE (Rev.1.1) numeric" ;
label variable PL111 "NACE (Rev 2) see also PL111_num" ;
...
6 "retired" 
7 "inactive"  
8 "other inactive (when time of unemployed, retirement & inactivity is > % of total time calendar)"
 ;
