* 2011_cross_eu_silc_p_ver_2021_04.do 
* 2nd update
*
...
*
* Pforr, Klaus and Johanna Jung (2021): 2011_cross_eu_silc_p_ver_2021_04.do, 2nd update.
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO SE SI SK UK { ;
      cd "$csv_path/`CC'/2011" ;	
	   import delimited using "UDB_c`CC'11P.csv", case(upper) clear ;
