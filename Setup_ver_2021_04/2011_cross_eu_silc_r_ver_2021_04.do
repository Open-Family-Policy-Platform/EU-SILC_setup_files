* 2011_cross_eu_silc_r_ver_2021_04.do 
* 2nd update
*
...
* 
* EU-SILC Cross 2011 - release 2021-04 / DOI: https://doi.org/10.2907/EUSILC2004-2019V.2 
*
...
*
* Pforr, Klaus and Johanna Jung (2021): 2011_cross_eu_silc_r_ver_2021_04.do, 2nd update.
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO SE SI SK UK { ;
      cd "$csv_path/`CC'/2011" ;
	   import delimited using "UDB_c`CC'11R.csv", case(upper) clear ;
...
label variable RL050 "Child care by a professional child-miner: hours of child care during an usual week" ;
label variable RL050_F "Flag" ;
label variable RL060 "Child care by grand-parents/other hhld members/relatives etc: ours during an usual week" ;
