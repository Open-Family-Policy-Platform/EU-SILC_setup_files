* 2012_cross_eu_silc_h_ver_2021_04.do 
* 2nd update
*
...
* 
* EU-SILC Cross 2012 - release 2021-04 / DOI: https://doi.org/10.2907/EUSILC2004-2019V.2 
*
...
*
* Pforr, Klaus and Johanna Jung (2021): 2012_cross_eu_silc_h_ver_2021_04.do, 2nd update.
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO SE SI SK UK { ;
      cd "$csv_path/`CC'/2012" ;
	   import delimited using "UDB_c`CC'12H.csv", case(upper) clear ;
...
1 "Yes ֠central heating or similar"
2 "Yes ֠other fixed heating"
3 "Yes ֠non-fixed heating"
4 "No ֠no heating at all"
;
...
1 "Yes ֠household will be forced to leave the dwelling"
2 "Yes ֠household plans to change the dwelling"
3 "No ֠household does not expect any change of the dwelling"
;
...
3 "Household will be forced to leave because of eviction"
...
label values HC030 HC040_VALUE_LABELS ;
...
label values HC030_F HC040_F_VALUE_LABELS ;
