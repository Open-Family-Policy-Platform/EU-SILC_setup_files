* 2013_cross_eu_silc_h_ver_2021_04.do 
* 2nd update
*
...
*
* Pforr, Klaus and Johanna Jung (2021): 2013_cross_eu_silc_h_ver_2021_04.do, 2nd update.
...
local log_file "$log/eusilc_2013_h" ;
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO RS SE SI SK UK { ;
      cd "$csv_path/`CC'/2013" ;
	   import delimited using "UDB_c`CC'13H.csv", case(upper) clear ;
...
label variable HD190 "Celebrations on special occasions (birthlabel name days, religious events, etc.)";
