* 2013_cross_eu_silc_r_ver_2021_04.do 
* 2nd update
*
...
*
* Pforr, Klaus and Johanna Jung (2021): 2013_cross_eu_silc_r_ver_2021_04.do, 2nd update.
...
local log_file "$log/eusilc_2013_r" ;
...
local stata_file "$log/eusilc_2013_r_cs" ;
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO RS SE SI SK UK { ;
      cd "$csv_path/`CC'/2013" ;
	   import delimited using "UDB_c`CC'13R.csv", case(upper) clear ;
...
label variable RL060 "Child care by grand-parents/other hhld members/relatives etc: Hours during an usual week" ;
...
label data "Personal register file 2013" ;
