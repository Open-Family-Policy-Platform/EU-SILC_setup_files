* 2014_cross_eu_silc_d_ver_2021_04.do 
* 2nd update
*
...
*
* Pforr, Klaus and Johanna Jung (2021): 2014_cross_eu_silc_d_ver_2021_04.do, 2nd update.
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO RS SE SI SK UK { ;
      cd "$csv_path/`CC'/2014" ;		
	  import delimited using "UDB_c`CC'14D.csv", case(upper) clear ;
...
label define DB070_F_VALUE_LABELS            
 1 "filled"
-2 "not applicable"
11 "order on sampl.frame is fixed for all EU-SILC survey years; PSUs have an equal probability of selection (within explicit strata)"
...
21 "order on sampl.frame may change over time; PSUs have an equal probability of selection (within explicit strata)"
22 "order on sampl.frame may change over time; PSUs have an unequal probability of selection (within explicit strata)"
;
