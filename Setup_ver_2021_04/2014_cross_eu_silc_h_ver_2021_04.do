* 2014_cross_eu_silc_h_ver_2021_04.do 
* 2nd update
*
...
* 
* EU-SILC Cross 2014 - release 2021-04 / DOI: https://doi.org/10.2907/EUSILC2004-2019V.2 
*
...
*
* Pforr, Klaus and Johanna Jung (2021): 2014_cross_eu_silc_h_ver_2021_04.do, 2nd update.
...
local log_file "$log/eusilc_2014_h" ;
...
local stata_file "$log/eusilc_2014_h_cs" ;
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO RS SE SI SK UK { ;
      cd "$csv_path/`CC'/2014" ;
	  import delimited using "UDB_c`CC'14H.csv", case(upper) clear ;
...
label variable HX040 "Household size (MT: Top coded to '6')" ;
...
label variable HY054G "Family/Children-related allowances (non-contributory and non means-tested)";
...
label variable HD120 "Fruit and vegetables once a day (variable partially differs from the 2009 module variablelabel variable HD120)";
label variable HD120_F "Flag";
label variable HD140 "One meal with meat, chicken or fish (or vegetarian equivalent) at least once a day";
label variable HD140_F "Flag";
label variable HD150 "Books at home suitable for that age";
...
label variable HD170 "Indoor games (educational baby toys, building blocks, board games, computergames, etc.)";
label variable HD170_F "Flag";
label variable HD180 "Regular leisure activity (swimming, playing an instrument, youth organisations, etc.)";
...
label variable HD240 "Go on holiday away from home at least 1 week per year (Warning: Slight change compared to the 2009 HD240)";
...
51 "collec. unknownrecorded net of tax on income & social contrib."
...
11 "collec. & recorded net of tax on income at source & social contrib."
22 "collec. & recorded net of tax on income at source" 
23 "collec. net of tax on income at source & recorded net of tax on social contrib." 
31 "collec. net of tax on social contrib.recorded net of tax on income & social contrib."
33 "collec. & recorded net of tax on social contrib."
41 "collec. gross-recorded net of tax on income & social contrib."
42 "collec. gross-recorded net of tax on income at source"
...
0	 "No income"
-1	 "missing"
-2	 "N/A This scheme doesn't exist at national level"
-7	 "N/A HB010 < 2014"
;
...
label define HH031_VALUE_LABELS       
 1959 "1959; PT: 1959 and earlier"
 1943 "1943; SI: 1943 and earlier"
;
...
label values HY051G_F HY061G_F HY071G_F HY052G_F HY062G_F HY072G_F HY053G_F HY063G_F HY073G_F  HY054G_F HY064G_F HY074G_F    HY051G_F_VALUE_LABELS;
...
label data "Household data file 2014" ;
