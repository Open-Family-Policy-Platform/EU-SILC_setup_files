* 2014_cross_eu_silc_r_ver_2021_04.do
* 2nd update 
*
...
*
* Pforr, Klaus and Johanna Jung (2021): 2014_cross_eu_silc_r_ver_2021_04.do, 2nd update.
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO RS SE SI SK UK { ;
      cd "$csv_path/`CC'/2014" ;
	  import delimited using "UDB_c`CC'14R.csv", case(upper) clear ;
