* 2015_cross_eu_silc_p_ver_2021_04.do 
* 2nd update
*
...
* 
* EU-SILC Cross 2015 - release 2021-04 / DOI: https://doi.org/10.2907/EUSILC2004-2019V.2 
*
...
*
* Pforr, Klaus and Johanna Jung (2021): 2015_cross_eu_silc_p_ver_2021_04.do, 2nd update.
...
local log_file "$log/eusilc_2015_p" ;
...
local stata_file "$log/eusilc_2015_p_cs" ;
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO RS SE SI SK UK { ;
      cd "$csv_path/`CC'/2015" ;	
	  import delimited using "UDB_c`CC'15P.csv", case(upper) clear ;
	  * In IS PL111 is read as numeric.
...
replace PL111="" if PL111=="."|PL111==" ";

log using "`log_file'", replace text ;

* Drop wrongfully included variables ;
drop SUM_PY010N SUM_PY080N SUM_PY090N SUM_PY100N SUM_PY050N ;
...
label variable PB140 "Year of birth (DE: Age group pertubation; MT: 5 yr groups)" ;
...
label variable PY120N "Sickness benefits (net, DE, SI: Top coding)" ;
label variable PY120N_F "Flag" ;
label variable PY120N_I "Imputation factor" ;
label variable PY130N "Disability benefits (net, DE, SI: Top coding)" ;
label variable PY130N_F "Flag" ;
label variable PY130N_I "Imputation factor" ;
label variable PY140N "Education-related allowances (net, DE, SI: Top coding)" ;
...
* Ad-hoc- module ;
label variable PS010 "Going to cinema";
label variable PS010_F "Flag";
label variable PS020 "Going to live performances";
label variable PS020_F "Flag";
label variable PS030 "Visits to cultural sites";
label variable PS030_F "Flag";
label variable PS040 "Attendance of live sport events";
label variable PS040_F "Flag";
label variable PS041 "Practice of artistic activities";
label variable PS041_F "Flag";
label variable PS050 "Frequency of getting toghether with family (relatives)";
...
label variable PS081 "Communication via social media";
label variable PS081_F "Flag";
label variable PS090 "Help from others";
label variable PS090_F "Flag";
label variable PS091 "Personal matters (anyone to discuss with)";
label variable PS091_F "Flag";
label variable PS100 "Participation in informal voluntary activities";
label variable PS100_F "Flag";
label variable PS101 "Participation in formal volunatry work";
label variable PS101_F "Flag";
...
21 "Collected net of tax on income at source/recorded net of tax on income at source & social contrib"
...
-3	"Not selected respondent"
-2	"Not available (no relatives)"
-1	"Missing"
1 "Filled"
-7	"Not applicable: PB010 not equal last year"
;	
label define PS060_VALUE_LABELS
1 "Daily"
2 "Every week (not every day)"
3 "Several times a month (not every week)"
4 "Once a month"
...
6 "Never"
;		
label define PS060_F_VALUE_LABELS
-3 "Not selected respondent"
-2 "Not available  (no friends)"
-1 "Missing"
1 "Filled"
-7	"Not applicable: PB010 not equal last year"
;	
label define PS070_VALUE_LABELS
1 "Daily"
2 "Every week (not every day)"
3 "Several times a month (not every week)"
4 "Once a month"
...
6 "Never"
;		
label define PS070_F_VALUE_LABELS
-3	"Not selected respondent"
-2	"Not available (no relatives)"
-1	"Missing"
1 "Filled"
-7	"Not applicable: PB010 not equal last year"
;	
label define PS080_VALUE_LABELS
1 "Daily"
2 "Every week (not every day)"
3 "Several times a month (not every week)"
4 "Once a month"
...
6 "Never"
;		
label define PS080_F_VALUE_LABELS
-3 "Not selected respondent"
-2 "Not available  (no friends)"
-1 "Missing"
1 "Filled"
-7	"Not applicable: PB010 not equal last year"
;	
label define PS081_VALUE_LABELS
1 "Daily"
2 "Every week (not every day)"
3 "Several times a month (not every week)"
4 "Once a month"
...
6 "Never"
;		
label define PS081_F_VALUE_LABELS
-3 "Not selected respondent"
-1 "Missing"
1 "Filled"
-7 "Not applicable: PB010 not equal last year"
;	
label define PS090_VALUE_LABELS
1 "Yes"
2 "No"
;	
label define PS090_F_VALUE_LABELS
-3 "Not selected respondent"
-2 "Not available  (no relatives, friends, neighbours)"
-1 "Missing"
1 "Filled"
-7	"Not applicable: PB010 not equal last year"
;	
label define PS091_VALUE_LABELS
1 "Yes"
2 "No"
;	
label define PS091_F_VALUE_LABELS
-3 "Not selected respondent"
-1 "Missing"
1 "Filled"
-7 "Not applicable: PB010 not equal last year"
;	
label define PS100_VALUE_LABELS
1 "Yes"
2 "No - lack of interest"
3 "No - lack of time"
4 "No - other reason"
;	
label define PS100_F_VALUE_LABELS
1 "Filled"
-1 "Missing"
-3 "Not selected respondent"
-7 "Not applicable: PB010 not equal last year"
;	
label define PS101_VALUE_LABELS
1 "Yes"
2 "No - lack of interest"
3 "No - lack of time"
4 "No - other reason"
;	
label define PS101_F_VALUE_LABELS
1 "Filled"
-1 "Missing"
-3 "Not selected respondent"
-7 "Not applicable: PB010 not equal last year"
...
4 "No - other reason"
;	
label define PS102_F_VALUE_LABELS
1 "Filled"
-1 "Missing"
-3 "Not selected respondent"
-7 "Not applicable: PB010 not equal last year"
...
label values PL211A PL211B PL211C PL211D PL211E PL211F PL211G ///
             PL211H PL211I PL211J PL211K PL211L PL211A_VALUE_LABELS ; 
...
label values PS041_F PS041_F_VALUE_LABELS	;
label values PS050 PS050_VALUE_LABELS	;
label values PS050_F PS050_F_VALUE_LABELS	;
label values PS060 PS060_VALUE_LABELS	;
label values PS060_F PS060_F_VALUE_LABELS	;
label values PS070 PS070_VALUE_LABELS	;
label values PS070_F PS070_F_VALUE_LABELS	;
label values PS080 PS080_VALUE_LABELS	;
label values PS080_F PS080_F_VALUE_LABELS	;
label values PS081 PS081_VALUE_LABELS	;
label values PS081_F PS081_F_VALUE_LABELS	;
label values PS090 PS090_VALUE_LABELS	;
label values PS090_F PS090_F_VALUE_LABELS	;
label values PS091 PS091_VALUE_LABELS	;
label values PS091_F PS091_F_VALUE_LABELS	;
label values PS100 PS100_VALUE_LABELS	;
label values PS100_F PS100_F_VALUE_LABELS	;
label values PS101 PS101_VALUE_LABELS	;
label values PS101_F PS101_F_VALUE_LABELS	;
label values PS102 PS102_VALUE_LABELS	;
label values PS102_F PS102_F_VALUE_LABELS	;

label data "Personal data file 2015" ;
