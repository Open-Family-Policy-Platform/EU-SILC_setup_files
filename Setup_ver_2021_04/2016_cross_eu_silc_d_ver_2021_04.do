* 2016_cross_eu_silc_d_ver_2021_04.do 
* 2nd update
*
...
*
* Pforr, Klaus and Johanna Jung (2021): 2016_cross_eu_silc_d_ver_2021_04.do, 2nd update.
...
local log_file "$log/eusilc_2016_d" ;
...
local stata_file "$log/eusilc_2016_d_cs" ;
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO RS SE SI SK UK { ;
      cd "$csv_path/`CC'/2016" ;		
	  import delimited using "UDB_c`CC'16D.csv", case(upper) clear ;
...
label data "Household register file 2016" ;
