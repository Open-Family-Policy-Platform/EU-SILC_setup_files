* 2016_cross_eu_silc_h_ver_2021_04.do 
* 2nd update
*
...
* 
* EU-SILC Cross 2016 - release 2021-04 / DOI: https://doi.org/10.2907/EUSILC2004-2019V.2 
*
...
*
* Pforr, Klaus and Johanna Jung (2021): 2016_cross_eu_silc_h_ver_2021_04.do, 2nd update.
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO RS SE SI SK UK { ;
      cd "$csv_path/`CC'/2016" ;		
	  import delimited using "UDB_c`CC'16H.csv", case(upper) clear ;
...
label variable HC190	"Presence in the household of people who need help due to long-term physical or mental ill-health, infirmity or because of oldage" ;
