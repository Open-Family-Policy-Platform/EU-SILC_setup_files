* 2016_cross_eu_silc_p_ver_2021_04.do 
* 2nd update
*
...
*
* Pforr, Klaus and Johanna Jung (2021): 2016_cross_eu_silc_p_ver_2021_04.do, 2nd update.
...
local log_file "$log/eusilc_2016_p" ;
...
local stata_file "$log/eusilc_2016_p_cs" ;
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO RS SE SI SK UK { ;
      cd "$csv_path/`CC'/2016" ;		
	  import delimited using "UDB_c`CC'16P.csv", case(upper) clear ;
	  * Some non-numeric characters are wrongfully included.
		* This command prevents errors in the format. ;
		destring PB120, ignore ("**")replace ;
...
3 "any other country (DE,EE,LV,MT,SI: 2,3=3)" 
;
...
label variable PB150 "Sex (DE: In same sex HH: recoded gender)" ;
...
/*label variable PB210_num "Country of birth numeric (DE,EE,LV,MT,SI: Recoded)" ;*/
label variable PB210_F "Flag" ;
label variable PB220A "Citizenship 1 alphanumeric (DE,EE,LV,MT,SI: Recoded)" ;
/*label variable PB220A_num "Citizenship 1 numeric (DE,EE,LV,MT,SI: Recoded)" ;*/
...
label variable PL051 "Occupation (ISCO-08 (COM)) (DE, MT,PT, SI: grouped)" ;
...
label variable PL075 "Number of months spent at full-time work as self-employed (including family worker)" ;
...
label variable PY021G "Company car (gross, in Euros, SI: Top coding)" ;
label variable PY021G_F "Flag" ;
label variable PY021G_I "Imputation factor" ;
label variable PY030G  "Employers social insurance contribution (gross, in Euros, SI: Top coding)" ;
label variable PY030G_F "Flag" ;
label variable PY030G_I "Imputation factor" ;
label variable PY031G "Optional employer social insurance contributions (gross, in Euros, SI: Top coding)" ;
label variable PY031G_F "Flag" ;
label variable PY031G_I "Imputation factor" ;
label variable PY035G "Contributions to individual private pension plans (gross, in Euros, SI: Top coding)" ;
label variable PY035G_F "Flag" ;
label variable PY035G_I "Imputation factor" ;
label variable PY050G "Cash benefits or losses from self-employment (gross, DE, SI: Top & bottom coding)" ;
...
label variable PY021N   "Company car (net, in Euros, SI: Top coding)" ;
...
* Ad-hoc module ;
label variable PC110 "Unmet needs for formal education";
label variable PC110_F "Flag";
label variable PC120 "Main reason for non-participation in formal education";
label variable PC120_F "Flag";
label variable PC130 "Participation in training related to hobbies";
label variable PC130_F "Flag";
label variable PC140 "Participation in training related to professional activity";
label variable PC140_F "Flag";
label variable PC150 "Main reason for non-participation in training related to professional activity";
label variable PC150_F "Flag";
label variable PC260 "Care or assistance provided";
label variable PC260_F "Flag";
label variable PC270 "Number of hours per week of care or assistance provided";
label variable PC270_F "Flag";
...
0 "pre-primary education (PB010<2014); early childhood education (PB010>2013)"
1 "primary education (PB010<2014)"
2 "lower secondary education (PB010<2014)"
3 "(upper) secondary education (PB010<2014)"
4 "post-secondary non-tertiary education (PB010<2014)"
5 "1st stage & 2nd stage of tertiary education (PB010<2014)"
6 "second stage of tertiary education (leading to an advanced research qualification) (PB010<2014)"
...
label define PE020_F_VALUE_LABELS             
 1 "Filled"
-1 "Missing"
-2  "Not available (PE010 not=1)"
;
label define PE030_VALUE_LABELS 
1945 "1945 SI: bottom coding"
;
label define PE030_F_VALUE_LABELS            
 1 "Filled"
-1 "Missing"
-2 "Not available (the person has never been in education)"
;
...
-5 "missig vlaue of PL051 because Pl050 is still used"
;
...
13 "Collec.net of tax on income source and soc. contrib.recorded & record net of tax on social contrib."   
...
56 "Type of collection unkown & recording is mix (parts of the component collected according to different methods)"
...
* Ad-hoc module ;
label define PC110_VALUE_LABELS
1 "Yes"
2 "No"
;
label define PC110_F_VALUE_LABELS
1 "Filled"
-1 "Missing"
-3 "Not selected respondent"
-4 "Person currently in formal education"
-7 "Not applicable PB010 is unequal 2016"
;
label define PC120_VALUE_LABELS
1 "Cannot afford it"
...
5 "Other reasons"
;
label define PC120_F_VALUE_LABELS
1 "Filled"
-1 "Missing"
...
-7 "Not applicable PB010 is unequal 2016"
;
label define PC130_VALUE_LABELS
1 "Yes"
2 "No"
;
label define PC130_F_VALUE_LABELS
1 "Filled"
-1 "Missing"
-3 "Not selected respondent"
-7 "Not applicable PB010 is unequal 2016"
;
label define PC140_VALUE_LABELS
1 "Yes"
2 "No"
;
label define PC140_F_VALUE_LABELS
1 "Filled"
-1 "Missing"
-3 "Not selected respondent"
-7 "Not applicable PB010 is unequal 2016"
;
label define PC150_VALUE_LABELS
1 "Cannot afford it"
2 "Not interested"
3 "Time constraints (schedule, family responsibilities, etc.)"
4 "No suitable courses or programmes available"
5 "Not provided by employer"
6 "Other reasons"
;
label define PC150_F_VALUE_LABELS
1 "Filled"
-1 "Missing"
...
-7 "Not applicable PB010 is unequal 2016"
;
label define PC260_VALUE_LABELS
1 "Yes – only to household members (DE: 1-3 Yes)"
...
* Ad-hoc module ;
label values PC110 PC110_VALUE_LABELS ;
label values PC110_F PC110_F_VALUE_LABELS ;
label values PC120 PC120_VALUE_LABELS ;
label values PC120_F PC120_F_VALUE_LABELS ;
label values PC130 PC130_VALUE_LABELS ;
label values PC130_F PC130_F_VALUE_LABELS ;
label values PC140 PC140_VALUE_LABELS ;
label values PC140_F PC140_F_VALUE_LABELS ;
label values PC150 PC150_VALUE_LABELS ;
label values PC150_F PC150_F_VALUE_LABELS ;
label values PC260 PC260_VALUE_LABELS ;
label values PC260_F PC260_F_VALUE_LABELS ;
label values PC270 PC270_VALUE_LABELS ;
label values PC270_F PC270_F_VALUE_LABELS ;

label data "Personal data file 2016" ;
