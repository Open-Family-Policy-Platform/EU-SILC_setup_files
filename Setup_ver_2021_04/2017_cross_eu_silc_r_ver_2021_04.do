* 2017_cross_eu_silc_r_ver_2021_04.do 
* 2nd update
*
...
*
* Pforr, Klaus and Johanna Jung (2021): 2017_cross_eu_silc_r_ver_2021_04.do, 2nd update.
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO RS SE SI SK UK { ;
      cd "$csv_path/`CC'/2017" ;
	  import delimited using "UDB_c`CC'17R.csv", case(upper) clear ;
...
1 "Filled"
-1 "Missing"
-2 "Not applicable: RB110 not equal to 1, 2, 3 or 4 (person is not a current household member) -5 Not applicable (person is not aged 0 - 15 years)"
