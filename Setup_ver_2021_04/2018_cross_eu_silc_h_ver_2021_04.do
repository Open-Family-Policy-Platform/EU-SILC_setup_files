* 2018_cross_eu_silc_h_ver_2021_04.do 
* 2nd update
*
...
*
* Pforr, Klaus and Johanna Jung (2021): 2018_cross_eu_silc_h_ver_2021_04.do, 2nd update.
...
local log_file "$log/eusilc_2018_h" ;

* The following command should contain the complete path where the CSV data files are stored
* Change CSV_PATH to your file path (e.g.: C:/EU-SILC/Crossectional 2004-2018) 
...
local stata_file "$log/eusilc_2018_h_cs" ;
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO RS SE SI SK UK { ;
      cd "$csv_path/`CC'/2018" ;		
	  import delimited using "UDB_c`CC'18H.csv", case(upper) clear ;
...
label variable HY010 "Total household gross income (DE, EE, MT, SI, UK: Adjustments)" ; 
label variable HY010_F "Flag" ;
label variable HY010_I "Imputation factor" ;
label variable HY020 "Total disposable household income (DE, EE, MT, SI, UK: Adjustments)" ; 
label variable HY020_F "Flag" ;
label variable HY020_I "Imputation factor" ;
label variable HY022 "Total disposable household income before social transfers other than old-age and survivors benefits (DE, EE, MT, SI, UK: Adjustments)" ; 
label variable HY022_F "Flag" ;
label variable HY022_I "Imputation factor" ;
label variable HY023 "Total disposable household income before social transfers including old-age and survivors benefits (DE, EE, MT, SI, UK: Adjustments)" ; 
...
label variable HY040G "Income from rental of a property or land (gross; DE, MT, SI: Top & bottom coding)" ;
label variable HY040G_F "Flag" ;
label variable HY040G_I "Imputation factor" ;
label variable HY050G  "Family/children related allowances (gross; MT, SI: Top & bottom coding)" ;
...
label variable HY052G "Family/children-related allowances (contributory and non means-tested, MT: Top & bottom coding)";
label variable HY052G_F "Flag";
label variable HY053G  "Family/children-related allowances (non-contributory and means-tested, MT: Top & bottom coding)";
label variable HY053G_F "Flag";
label variable HY054G "Family/children-related allowance (non-contributory and non means-tested, MT: Top & bottom coding)";
label variable HY054G_F "Flag";
label variable HY060G  "Social exclusion not elsewhere classified (gross; MT, SI: Top & bottom coding)" ;
...
label variable HY063G  "Social exclusion not elsewhere classified (non-contributory and means-tested, MT: Top & bottom coding)";
...
label variable HY070G "Housing allowances (gross; MT, SI: Top & bottom coding)" ;
...
label variable HY073G  "Housing allowances (non-contributory and means-tested, MT: Top & bottom coding)";
...
label variable HY080G "Regular inter-household cash transfer received (gross; MT, SI: Top & bottom coding)" ;
label variable HY080G_F "Flag" ;
label variable HY080G_I "Imputation factor" ;
label variable HY081G "Alimonies received (gross; MT, SI: Top & bottom coding)" ;
label variable HY081G_F "Flag" ;
label variable HY081G_I "Imputation factor" ;
label variable HY090G "Interests, dividends, profit from capital investment in uncorporated business (gross; DE, EE, MT, SI, UK: Top & bottom coding)"  ;
...
label variable HY110G "Income received by people aged under 16 (gross; MT, SI: Top & bottom coding)" ;
...
label variable HY130G "Regular interhousehold cash transfer paid (gross; MT, SI: Top & bottom coding)" ;
label variable HY130G_F "Flag" ;
label variable HY130G_I "Imputation factor" ;
label variable HY131G   "Alimonies paid (gross; MT, SI: Top & bottom coding)" ;
label variable HY131G_F "Flag" ;
label variable HY131G_I "Imputation factor" ;
label variable HY140G "Tax on income and social contributions (gross; DE, EE, MT, UK: Top & bottom coding)" ;
...
label variable HY030N "Imputed rent (net, MT: Top & bottom coding)" ; 
label variable HY030N_F "Flag" ;
label variable HY040N "Income from rental of a property or land (net; DE, MT, SI: Top & bottom coding)" ; 
label variable HY040N_F "Flag" ;
label variable HY040N_I "Imputation factor" ;
label variable HY050N "Family/Children related allowances (net; MT, SI: Top & bottom coding)" ;
label variable HY050N_F "Flag" ;
label variable HY050N_I "Imputation factor" ;
label variable HY060N "Social exclusion not elsewhere classified (net; MT, SI: Top & bottom coding)" ;
label variable HY060N_F "Flag" ; 
label variable HY060N_I "Imputation factor" ;
label variable HY070N "Housing allowances (net; MT, SI: Top & bottom coding)" ;
label variable HY070N_F "Flag" ;
label variable HY070N_I "Imputation factor" ;
label variable HY080N "Regular inter-household cash received (net; MT, SI: Top & bottom coding)" ;
...
label variable HY090N "Interests, dividends, profit from capital investment in uncorporated business (net; DE, MT, SI, UK: Top & bottom coding)" ;
...
label variable HY145N "Repayments/receipts for tax adjustment (net; DE, SI: Top & bottom coding)" ;
...
label define HH031_VALUE_LABELS       
 1963 "PT: 1963 and earlier"
 1947 "SI: 1947 and earlier"
;
...
label values HY040N_F HY050N_F HY060N_F HY070N_F HY080N_F ///
             ...
             HY130N_F HY131N_F HY145N_F HY170N_F HY090N_F HY040N_F_VALUE_LABELS ;
...
label data "Household data file 2018" ;
