* 2018_cross_eu_silc_p_ver_2021_04.do 
* 2nd update
*
...
* 
* EU-SILC Cross 2018 - release 2021-04 / DOI: https://doi.org/10.2907/EUSILC2004-2019V.2 
*
...
* Country files are delivered in the format UDB_l*country_stub*18H.csv
* 
* (c) GESIS 2021-11-17
* 
* PLEASE NOTE
...
*
* Pforr, Klaus and Johanna Jung (2021): 2018_cross_eu_silc_p_ver_2021_04.do, 2nd update.
...
local log_file "$log/eusilc_2018_p" ;
...
local stata_file "$log/eusilc_2018_p_cs" ;
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO RS SE SI SK UK { ;
      cd "$csv_path/`CC'/2018" ;	
	  import delimited using "UDB_c`CC'18P.csv", case(upper) clear ;
...
* A variable from the R-file was wrongly included;
drop RB260 ;
...
label variable PB210 "Country of birth alphanumeric (DE,EE,LV,MT,SI: 2,3=3)" ;
label variable PB210_F "Flag" ;
label variable PB220A "Citizenship 1 alphanumeric (DE,EE,LV,MT,SI: 2,3=3)" ;
...
label variable PL075 "Number of months spent at full-time work as self-employed (including family worker) (MT: Top coding)" ;
label variable PL075_F "Flag" ;
label variable PL076 "Number of months spent at part-time work as self-employed (including family worker)" ;
...
label variable PL086 "Number of months spent as disabled or/and unfit to work (MT: Top coding)" ;
...
label variable PY010G "Employee cash or near cash income (gross, DE, MT, SI: Top & bottom coding)" ;
label variable PY010G_F "Flag" ;
label variable PY010G_I "Imputation factor" ;
label variable PY020G "Non-cash employee income (gross, MT: Top & bottom coding)" ;  
label variable PY020G_F "Flag" ;
label variable PY020G_I "Imputation factor" ; 
label variable PY021G "Company car (in Euros, MT, SI: Top & bottom coding)" ;
...
label variable PY035G "Contributions to individual private pension plans (gross, MT, SI: Top & bottom coding)" ;
label variable PY035G_F "Flag" ;
label variable PY035G_I "Imputation factor" ;
label variable PY050G "Cash benefits or losses from self-employment (gross, DE, MT, SI: Top & bottom coding)" ;
label variable PY050G_F "Flag" ;
label variable PY050G_I "Imputation factor" ;
label variable PY080G  "Pension from individual private plans (gross, DE, MT, SI: Top & bottom coding)" ;
label variable PY080G_F "Flag" ;
label variable PY080G_I "Imputation factor" ;
label variable PY090G  "Unemployment benefits (gross, DE, MT, SI: Top & bottom coding)" ;
...
label variable PY100G "Old-age benefits (gross, DE, MT, SI: Top & bottom coding)" ;
...
label variable PY110G "Survivor benefit (gross, MT, SI: Top & bottom coding)" ;
...
label variable PY120G "Sickness benefits (gross, MT, SI: Top & bottom coding)" ;
...
label variable PY130G "Disability benefits (gross, MT, SI: Top & bottom coding)" ;
...
label variable PY140G "Education-related allowances (gross, MT, SI: Top & bottom coding)" ;
...
label variable PY144G "Education-related allowances (non-contributory and non means-tested, SI: Adjustments)";
...
* Ad-hoc module for well-being ;
label variable PW005T "Module on well-being weight";
label variable PW005T_F "Flag";
label variable PW010T "Overall life satisfaction";
label variable PW010T_F "Flag";
label variable PW030T "Satisfaction with financial situation of your household";
label variable PW030T_F "Flag";
label variable PW040T "Material help";
label variable PW050T "Being very nervous";
label variable PW060T "Feeling down in the dumps";
label variable PW070T "Feeling calm and peaceful";
label variable PW080T "Feeling downhearted or depressed";
label variable PW090T "Have you been happy?";
label variable PW090T_F "Flag";
label variable PW100T "Satisfaction with your present job";
label variable PW100T_F "Flag";
label variable PW110T "Non-material help";
label variable PW120T "Satisfaction with time use (amount of leisure time)";
label variable PW160T "Satisfaction with your personal relationships with family, friends, neighbourhood and other";
label variable PW160T_F "Flag";
label variable PW190T "Trust in others";
label variable PW230T "Feeling lonely";
label variable PW240T "Perceived social exclusion";
...
1946 "1946 IE: bottom coding"
1947 "1947 SI: bottom coding"
;
...
10  "MT: 10 to 12"
;
label define PL086_VALUE_LABELS              
10  "MT: 10 to 12"
;
...
* Ad-hoc module for well-being ;
label define PW005T_F_VALUE_LABELS                
1 "Filled"
-1 "Missing"
-3 "Not selected respondent"
-7 "Not applicable (PB010 not equal to 2018)"
-8 "Not applicable (variable not constructed)"
;
label define PW010T_VALUE_LABELS                
0 "Not all all satisfied"
10 "Completely satisfied"
99 "Don't know"
;
label define PW010T_F_VALUE_LABELS                
1 "Filled"
-1 "Missing"
-3 "Not selected respondent"
-7 "Not applicable (PB010 not equal to 2018)"
;
label define PW030T_F_VALUE_LABELS                
1 "Filled"
-1 "Missing"
-3 "Not selected respondent"
-7 "Not applicable (PB010 not equal to 2018)"
;
label define PW040T_VALUE_LABELS  
1 "Yes"
2 "No"
;
label define PW050T_VALUE_LABELS  
1 "All of the time"
2 "Most of the time"
3 "Some of the time"
...
99 "Do not know"
;
label define PW090T_F_VALUE_LABELS                
1 "Filled"
-1 "Missing"
-3 "Not selected respondent"
-7 "Not applicable (PB010 not equal to 2018)"
;
label define PW100T_VALUE_LABELS                
0 "Not all all satisfied"
10 "Completely satisfied"
99 "Don't know"
;
label define PW100T_F_VALUE_LABELS                
1 "Filled"
-1 "Missing"
-2 "Not applicable (PL031 not equal to 1,2,3,4)"
-3 "Not selected respondent"
-7 "Not applicable (PB010 not equal to 2018)"
;
label define PW120T_VALUE_LABELS  
0 "Not all all satisfied"
10 "Completely satisfied"
99 "Don't know"
;
label define PW160T_VALUE_LABELS                
0 "Not all all satisfied"
10 "Completely satisfied"
99 "Don't know"
;
label define PW190T_VALUE_LABELS  
0 "Do not trust at all"
10 "Trust completely"
99 "Don't know"
;
label define PW240T_VALUE_LABELS  
...
label values PL075 PL075_VALUE_LABELS ;
label values PL086 PL086_VALUE_LABELS ;
...
* Ad-hoc module for well-being ;
label values PW005T_F PW005T_F_VALUE_LABELS ;
label values PW010T PW030T PW010T_VALUE_LABELS ;
label values PW010T_F PW010T_F_VALUE_LABELS ;
label values PW030T_F PW030T_F_VALUE_LABELS ;
label values PW040T PW110T PW040T_VALUE_LABELS ;
label values PW050T PW060T PW070T PW080T PW090T PW230T PW050T_VALUE_LABELS ;
label values PW090T_F PW160T_F PW090T_F_VALUE_LABELS ;
label values PW100T PW100T_VALUE_LABELS ;
label values PW100T_F PW100T_F_VALUE_LABELS ;
label values PW120T PW120T_VALUE_LABELS ;
label values PW160T PW160T_VALUE_LABELS ;
label values PW190T PW190T_VALUE_LABELS ;
label values PW240T PW240T_VALUE_LABELS ;

label data "Personal data file 2018" ;
