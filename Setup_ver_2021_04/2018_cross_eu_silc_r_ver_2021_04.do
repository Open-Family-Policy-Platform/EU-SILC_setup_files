* 2018_cross_eu_silc_r_ver_2021_04.do 
* 2nd update
*
...
*
* Pforr, Klaus and Johanna Jung (2021): 2018_cross_eu_silc_r_ver_2021_04.do, 2nd update.
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO RS SE SI SK UK { ;
      cd "$csv_path/`CC'/2018" ;
	  import delimited using "UDB_c`CC'18R.csv", case(upper) clear ;
...
label variable RL050 "Childcare by a professional child-minder: hours of child care during an usual week" ;
label variable RL050_F "Flag" ;
label variable RL060 "Childcare by grand-parents/other hhld members/relatives etc: hours during an usual week" ;
...
label variable RX020 "Age at the end of the income reference period (DE: age group pertubation, MT: missing" ;
