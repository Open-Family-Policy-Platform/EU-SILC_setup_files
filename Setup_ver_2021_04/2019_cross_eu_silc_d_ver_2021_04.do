* 2019_cross_eu_silc_d_ver_2021_04.do 
* 2nd update
*
...
* Country files are delivered in the format UDB_c*country_stub*19D.csv
* 
* (c) GESIS 2021-11-17
*
* PLEASE NOTE
...
*
* Pforr, Klaus and Johanna Jung (2021): 2019_cross_eu_silc_d_ver_2021_04.do, 2nd update.
...
local log_file "$log/eusilc_2019_d" ;
...
local stata_file "$log/eusilc_2019_d_cs" ;
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE /*IS*/ IT LT LU LV MT NL NO PL PT RO RS SE SI SK /*UK*/ { ;
      cd "$csv_path/`CC'/2019" ;		
	  import delimited using "UDB_c`CC'19D.csv", case(upper) clear ;
...
label variable DB040 "Region (DE, NL: missing)";
...
label data "Household register file 2019" ;
