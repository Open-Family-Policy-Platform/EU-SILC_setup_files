* 2019_cross_eu_silc_h_ver_2021_04.do 
* 2nd update
*
...
* Country files are delivered in the format UDB_c*country_stub*19H.csv
* 
* (c) GESIS 2021-11-17
*
* PLEASE NOTE
...
*
* Pforr, Klaus and Johanna Jung (2021): 2019_cross_eu_silc_h_ver_2021_04.do, 2nd update.
...
local log_file "$log/eusilc_2019_h" ;
...
local stata_file "$log/eusilc_2019_h_cs" ;
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE /*IS*/ IT LT LU LV MT NL NO PL PT RO RS SE SI SK /*UK*/ { ;
      cd "$csv_path/`CC'/2019" ;		
	  import delimited using "UDB_c`CC'19H.csv", case(upper) clear ;
...
label variable HY010 "Total household gross income (DE, EE, MT, SI, UK: Adjustments; MT: Top & bottom coding)" ; 
label variable HY010_F "Flag" ;
label variable HY010_I "Imputation factor" ;
label variable HY020 "Total disposable household income (DE, EE, MT, SI, UK: Adjustments; MT: Top & bottom coding)" ; 
label variable HY020_F "Flag" ;
label variable HY020_I "Imputation factor" ;
label variable HY022 "Total disposable household income before social transfers other than old-age and survivors benefits (DE, EE, MT, SI, UK: Adjustments; MT: Top & bottom coding)" ; 
label variable HY022_F "Flag" ;
label variable HY022_I "Imputation factor" ;
label variable HY023 "Total disposable household income before social transfers including old-age and survivors benefits (DE, EE, MT, SI, UK: Adjustments; MT: Top & bottom coding)" ; 
...
label variable HY040G "Income from rental of a property or land (gross; DE, SI: Top coding; MT: Top & bottom coding)" ;
label variable HY040G_F "Flag" ;
label variable HY040G_I "Imputation factor" ;
label variable HY050G  "Family/Children related allowances (gross; SI: Top codig; MT: Top & bottom coding)" ;
...
label variable HY060G  "Social exclusion not elsewhere classified (gross; SI: Top coding; MT: Top & bottom coding)" ;
...
label variable HY073G  "Housing allowances (non-contributory and means-tested, MT: Top & bottom coding; MT: Adjustments)";
...
label variable HY080G "Regular interhousehold cash transfer received (gross; SI: Top coding, MT: Top & bottom coding)" ;
...
label variable HY090G "Interests, dividends, profit from capital investment in uncorporated business (gross; DE, SI: Top coding; MT, UK: Top & bottom coding)"  ;
...
label variable HY110G "Income received by people aged under 16 (gross; SI: Top coding, MT: Top & bottom coding)" ;
...
label variable HY130G "Regular interhousehold cash transfer paid (gross; SI: Top coding, MT: Top & bottom coding)" ;
...
label variable HY140G "Tax on income and social contributions (gross; UK: Top coding; DE, MT: Top & bottom coding; MT: Adjustments)" ;
...
label variable HY090N "Interests, dividends, profit from capital investment in uncorporated business (net; DE: Top coding; MT SI, UK: Top & bottom coding)" ;
...
label variable HY140N "Tax on income and social contribution (net; DE: Top & bottom coding; MT: Adjustments)" ;
...
* Module on income change ;
label variable HI010 "Change in income compared to previous year (OPTIONAL)";
...
label variable HI040 "Future income (OPTIONAL)";
...
1 "Filled"
-1 "Missing"
-7 "Not applicable (HB010 ne 2019)"
...
label data "Household data file 2019" ;
