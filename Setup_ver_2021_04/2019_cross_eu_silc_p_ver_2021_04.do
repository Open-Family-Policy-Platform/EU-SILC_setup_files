* 2019_cross_eu_silc_p_ver_2021_04.do 
* 2nd update
*
...
* 
* EU-SILC Cross 2019 - release 2021-04 / DOI: https://doi.org/10.2907/EUSILC2004-2019V.2
*
...
* Country files are delivered in the format UDB_c*country_stub*19P.csv
* 
* (c) GESIS 2021-11-17
*
* PLEASE NOTE
...
*
* Pforr, Klaus and Johanna Jung (2021): 2019_cross_eu_silc_p_ver_2021_04.do, 2nd update.
...
local log_file "$log/eusilc_2019_p" ;
...
local stata_file "$log/eusilc_2019_p_cs" ;
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE /*IS*/ IT LT LU LV MT NL NO PL PT RO RS SE SI SK /*UK*/ { ;
      cd "$csv_path/`CC'/2019" ;	
	  import delimited using "UDB_c`CC'19P.csv", case(upper) clear ;
...
label variable PE020 "ISCED level currently attended (Top Coding 50 and above; DE, IT, MT, SI: specific rules)" ;
...
label variable PE040 "Highest ISCED level attained (Top coding 500 and above; IE, IT, SI: specific rules)" ;
...
label variable PL075 "Number of months spent at full-time work as self-employed (including family worker) (MT: Top & bottom coding)" ;
label variable PL075_F "Flag" ;
label variable PL076 "Number of months spent at part-time work as self-employed (including family worker) (MT: Top & bottom coding)" ;
...
label variable PL086 "Number of months spent as disabled or/and unfit to work (MT: Top & bottom coding)" ;
...
label variable PL089 "Number of months spent fulfilling domestic tasks and care responsibilities (MT: Top & bottom coding)" ;
...
label variable PL100 "Total number of hours usually worked in second, third...jobs (MT: Top & bottom coding)" ;
...
label variable PY010G "Employee cash or near cash income (gross, DE, SI: Top coding; MT: Top & bottom coding)" ;
...
label variable PY030G  "Employers social insurance contribution (in Euros, SI: Top coding; MT: Top & bottom coding)" ;
label variable PY030G_F "Flag" ;
label variable PY030G_I "Imputation factor" ;
label variable PY031G "Optional employer social insurance contributions (in Euros, SI: Top coding) (OPTIONAL)" ;
label variable PY031G_F "Flag" ;
label variable PY031G_I "Imputation factor" ;
label variable PY035G "Contributions to individual private pension plans (gross, SI: Top Coding; MT: Top & bottom coding)" ;
label variable PY035G_F "Flag" ;
label variable PY035G_I "Imputation factor" ;
label variable PY050G "Cash benefits or losses from self-employment (gross, SI: Top coding; DE, MT: Top & bottom coding)" ;
label variable PY050G_F "Flag" ;
label variable PY050G_I "Imputation factor" ;
label variable PY080G  "Pension from individual private plans (gross, DE, SI: Top coding; MT: Top & bottom coding)" ;
...
label variable PY091G "Unemployment benefits (contributory and means-tested, DE: Adjustments; MT: Top & bottom coding)";
label variable PY091G_F "Flag";
label variable PY092G "Unemployment benefits (contributory and means-tested, DE: Adjustments; MT: Top & bottom coding)";
label variable PY092G_F "Flag";
label variable PY093G "Unemployment benefits (contributory and means-tested, DE: Adjustments; MT: Top & bottom coding)";
label variable PY093G_F "Flag";
label variable PY094G "Unemployment benefits (non-contributory and non means-tested, DE, SI: Adjustments)";
...
label variable PY102G "Old-age benefits (contributory and non means-tested, DE, SI: Adjustments; MT: Top & bottom coding)";
label variable PY102G_F "Flag";
label variable PY103G "Old-age benefits (non-contributory and means-tested, DE: Adjustments; MT: Top & bottom coding)";
label variable PY103G_F "Flag";
label variable PY104G "Old-age benefits (non-contributory and non means-tested, DE, SI: Adjustments; MT: Top & bottom coding)";
...
label variable PY112G "Survivor benefits (contributory and non means-tested, SI: Adjustments; MT: Top & bottom coding)";
...
label variable PY122G "Sickness benefits (contributory and non means-tested; MT: Top & bottom coding; MT: Adjustments)";
...
label variable PY132G "Disability benefits (contributory and non means-tested, SI: Adjustments; MT: Top & bottom coding)";
label variable PY132G_F "Flag";                         
label variable PY133G "Disability benefits (non-contributory and means-tested, SI: Adjustments; MT: Top & bottom coding)";
label variable PY133G_F "Flag";
label variable PY134G "Disability benefits (non-contributory and non means-tested; MT: Top & bottom coding)";
...
label variable PY144G "Education-related allowances (non-contributory and non means-tested, SI: Adjustments; MT: Top & bottom coding)";
...
label variable PY050N "Cash benefits or losses from self-employment (net, SI: Top Coding; DE: Top & bottom coding)" ;
...
label variable PX020 "Age at the end of the income reference period (DE: age group pertubation, MT: Adjusted)" ;
label variable PX030 "Household ID" ;
label variable PX040 "Selected respondent status" ;
label variable PX050 "Activity status" ;

* Module on intergenerational transmission of disadvantages ;
label variable PT020 "Number of adults when respondent was around 14 years old" ;
label variable PT020_F "Flag" ;
label variable PT030 "Number of children when respondent was around 14 years old" ;
label variable PT030_F "Flag" ;
label variable PT040 "Number of persons in the household in work when respondent was around 14 years old" ;
label variable PT040_F "Flag" ;
label variable PT060 "Country of birth of the father (Recoded: DE, SI)" ;
label variable PT060_F "Flag" ;
label variable PT070 "Citizenship of the father (Recoded: DE, SI)" ;
label variable PT070_F "Flag" ;
label variable PT090 "Country of birth of the mother (Recoded: DE, SI)" ;
label variable PT090_F "Flag" ;
label variable PT100 "Citizenship of the mother (Recoded: DE, SI)" ;
...
label variable PT130 "Activity status of the father when respondent was around 14 years old" ;
label variable PT130_F "Flag" ;
label variable PT140 "Managerial position of the father when respondent was around 14 years old" ;
label variable PT140_F "Flag" ;
label variable PT150 "Main occupation of the father when respondent was around 14 years old (ISCO-08 (COM))" ;
label variable PT150_F "Flag" ;
label variable PT160 "Activity status of the mother when respondent was around 14 years old" ;
label variable PT160_F "Flag" ;
label variable PT170 "Managerial position of the mother when respondent was around 14 years old" ;
label variable PT170_F "Flag" ;
label variable PT180 "Main occupation of the mother when respondent was around 14 years old (ISCO-08 (COM))" ;
label variable PT180_F "Flag" ;
label variable PT190 "Financial situation of the household when respondent was around 14 years old" ;
label variable PT190_F "Flag" ;
label variable PT210 "Tenancy status when respondent was around 14 years old" ;
label variable PT210_F "Flag" ;
label variable PT220 "Type of household when respondent was around 14 years old" ;
label variable PT220_F "Flag" ;
label variable PT230 "Presence of mother when respondent was around 14 years old" ;
label variable PT230_F "Flag" ;
label variable PT240 "Presence of father when respondent was around 14 years old" ;
label variable PT240_F "Flag" ;
label variable PT250 "Degree of urbanisation when respondent was around 14 years old (Missing: SI)" ;
label variable PT250_F "Flag" ;
label variable PT260 "Basic school needs (books and equipment for school) met when respondent was around 14 years old" ;
label variable PT260_F "Flag" ;
label variable PT270 "Having meal with meat, chicken, fish (or vegetarian equivalent) daily when respondent was around 14 years old" ;
label variable PT270_F "Flag" ;
label variable PT280 "One week annual holiday away from home when respondent was around 14 years old" ;
label variable PT280_F "Flag" ;
...
20 "Lower secondary education (PB010>2013; MT,SI: 0,10,20=20)"
30 "Upper secondary education (not further specified) (PB010>2013; DE: 34,35=30; IT: 30,34,35=30)"
34 "General education (Only for people 16-34, PB010>2013)"
35 "Vocational education (Only for people 16-34, PB010>2013)"
40 "Post-secondary non tertiary education (not further specified) (PB010>2013; DE: 44,45=40; IT: 40,44,45=40)"
44 "General education (Only for people 16-34, PB010>2013)"
45 "Vocational education (Only for people 16-34, PB010>2013)"
50 "Short cycle tertiary (PB010>2013; MT: 50,60=50)"
...
300 "Upper secondary education (not further specified) (PB010>2013, DE: 340-354=300)"
34 "General education  (Only for people 16-34; PB010>2013)"
...
400 "Post-secondary non-tertiary education (not further specified) (PB010>2013, DE: 440-450=400)"
...
1 "Commissioned armed forces officers (DE, MT, SI: 11-14 Managers)"
...
4 "DE, MT, SI: 41-44 Clerical support workers"
5 "DE, MT, SI: 51-54 Services and sales workers"
...
14 "Hospitality, retail and other services managers (PT:11-13 = 14)"
...
-7 "Not applicable (PB010 ne 2019)"
;
...
* Module on intergenerational transmission of disadvantages ;
label values PT020 PT020_VALUE_LABELS ;
label values PT030 PT030_VALUE_LABELS ;
label values PT040 PT040_VALUE_LABELS ;
label values PT020_F PT030_F PT040_F PT190_F PT210_F PT220_F PT230_F PT240_F ///
             PT250_F PT260_F PT270_F PT280_F PT020_F_VALUE_LABELS ;
label values PT060_F PT070_F PT060_F_VALUE_LABELS ;
label values PT090_F PT100_F PT090_F_VALUE_LABELS ;
label values PT110 PT120 PT110_VALUE_LABELS ;
label values PT110_F PT110_F_VALUE_LABELS ;
label values PT120_F PT120_F_VALUE_LABELS ;
label values PT130 PT160 PT130_VALUE_LABELS ;
label values PT130_F PT130_F_VALUE_LABELS ;
label values PT140 PT170 PT140_VALUE_LABELS ;
label values PT140_F PT140_F_VALUE_LABELS ;
label values PT150 PT180 PT150_VALUE_LABELS ;
...
label values PT220 PT220_VALUE_LABELS ;
label values PT230 PT230_VALUE_LABELS ;
label values PT240 PT240_VALUE_LABELS ;
label values PT250 PT250_VALUE_LABELS ;
label values PT260 PT270 PT280 PT260_VALUE_LABELS ;
...
label data "Personal data file 2019" ;
