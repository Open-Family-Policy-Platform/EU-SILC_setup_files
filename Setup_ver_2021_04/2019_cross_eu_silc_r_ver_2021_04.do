* 2019_cross_eu_silc_r_ver_2021_04.do 
* 2nd update
*
...
*
* Pforr, Klaus and Johanna Jung (2021): 2019_cross_eu_silc_r_ver_2021_04.do, 2nd update.
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE /*IS*/ IT LT LU LV MT NL NO PL PT RO RS SE SI SK /*UK*/ { ;
      cd "$csv_path/`CC'/2019" ;
	  import delimited using "UDB_c`CC'19R.csv", case(upper) clear ;
...
label variable RL050 "Childcare by a professional child-minder: hours of child care during an usual week (MT: missing if RL050>0)" ;
