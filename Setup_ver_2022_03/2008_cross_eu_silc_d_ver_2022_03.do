* 2008_cross_eu_silc_d_ver_2022_03.do 
*
...
*
* Pforr, Klaus and Johanna Jung (2022): 2008_cross_eu_silc_d_ver_2022_03.do.
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HU IE IS IT LT LU LV MT NL NO PL PT RO SE SI SK UK { ;
      cd "$csv_path/`CC'/2008" ;	
	  import delimited using "UDB_c`CC'08D.csv", case(upper) asdouble clear ;
