* 2011_cross_eu_silc_h_ver_2022_03.do 
*
...
*
* Pforr, Klaus and Johanna Jung (2022): 2011_cross_eu_silc_h_ver_2022_03.do.
...
local log_file "$log/eusilc_2011_h" ;
...
local stata_file "$log/eusilc_2011_h_cs" ;
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO SE SI SK UK { ;
      cd "$csv_path/`CC'/2011" ;
	   import delimited using "UDB_c`CC'11H.csv", case(upper) asdouble clear ;
...
label variable HY080N "Regular inter-household cash transfer received (net)" ;
...
0 "HX090>= at risk of poverty threshold (60% of Median HX090)"
1 "HX090 < at risk of poverty threshold (60% of Median HX090)"
;
...
label values HH070_F HH071_F HH070_F_VALUE_LABELS ;
...
label data "Household data file 2011" ;
