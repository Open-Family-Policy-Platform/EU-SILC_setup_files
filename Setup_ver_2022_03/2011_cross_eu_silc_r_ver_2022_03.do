* 2011_cross_eu_silc_r_ver_2022_03.do
*
...
* 
* EU-SILC Cross 2011 - release 2021-09 / DOI: TBD 
*
...
* Country files are delivered in the format UDB_l*country_stub*11H.csv
* 
* (c) GESIS 2022-06-02
* 
* PLEASE NOTE
...
*
* Pforr, Klaus and Johanna Jung (2022): 2011_cross_eu_silc_r_ver_2022_03.do.
...
local log_file "$log/eusilc_2011_r" ;
...
local stata_file "$log/eusilc_2011_r_cs" ;
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO SE SI SK UK { ;
      cd "$csv_path/`CC'/2011" ;
	   import delimited using "UDB_c`CC'11R.csv", case(upper) asdouble clear ;
...
label variable RL030 "Child care at centre-based services: hours of child care during an usual week" ;
label variable RL030_F "Flag" ;
label variable RL040 "Child care at day-care centre: hours of child care during an usual week" ;
label variable RL040_F "Flag" ;
label variable RL050 "Child care by a professional child-minder at child's home/at child-minder's home" ;
label variable RL050_F "Flag" ;
label variable RL060 "Child care by grnd-prnts, oth hhld mmbrs (ex. prnts), oth rltvs, frnds or nghbrs" ;
...
label data "Personal register file 2011" ;
