* 2017_cross_eu_silc_h_ver_2022_03.do
*
...
* 
* EU-SILC Cross 2017 - release 2022-03 / DOI: TBD 
*
...
*
* Pforr, Klaus and Johanna Jung (2022): 2017_cross_eu_silc_h_ver_2022_03.do.
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO RS SE SI SK UK { ;
      cd "$csv_path/`CC'/2017" ;		
	  import delimited using "UDB_c`CC'17H.csv", case(upper) asdouble clear ;
...
label variable HY022 "Tt disp hhld inc bef soc trnsfrs ex old-age & srvvrs ben (DE, EE, SI, UK: Adj)" ; 
label variable HY022_F "Flag" ;
label variable HY022_I "Imputation factor" ;
label variable HY023 "Tt disp hhld inc bef soc trnsfrs inc old-age & srvvrs ben (DE, EE, SI, UK: Adj)" ; 
...
label variable HY090G "Intrsts, dvdnds, prft frm cptl invstmnt in uncorp bsn (g; DE, EE, SI, UK: T cod)"  ;
...
label variable HY090N "Intrsts, dvdnds, prft frm cptl invstmnt in uncorp bsn (net; DE, SI: T cod)" ;
...
label variable HC020T   "Main reason for unmet need for medical examination or treatmnt (child., DE: mis)" ;
...
label variable HC040T   "Main reason for unmet need for dental examintin or treatmnt (children, DE: mis)" ;
