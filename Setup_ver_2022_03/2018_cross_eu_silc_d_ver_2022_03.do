* 2018_cross_eu_silc_d_ver_2022_03.do 
*
...
*
* Pforr, Klaus and Johanna Jung (2022): 2018_cross_eu_silc_d_ver_2022_03.do.
...
local log_file "$log/eusilc_2018_d" ;
...
local stata_file "$log/eusilc_2018_d_cs" ;
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO RS SE SI SK UK { ;
      cd "$csv_path/`CC'/2018" ;		
	  import delimited using "UDB_c`CC'18D.csv", case(upper) asdouble clear ;
...
label data "Household register file 2018" ;
