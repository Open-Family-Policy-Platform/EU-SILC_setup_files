* 2018_cross_eu_silc_h_ver_2022_03.do 
*
...
*
* Pforr, Klaus and Johanna Jung (2022): 2018_cross_eu_silc_h_ver_2022_03.do.
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO RS SE SI SK UK { ;
      cd "$csv_path/`CC'/2018" ;		
	  import delimited using "UDB_c`CC'18H.csv", case(upper) asdouble clear ;
...
label variable HY022 "Tt disp hhld inc bef soc trnsfrs ex old-age & srvvrs ben (DE,EE,MT,SI,UK: Adj)" ; 
label variable HY022_F "Flag" ;
label variable HY022_I "Imputation factor" ;
label variable HY023 "Tt disp hhld inc bef soc trnsfrs inc old-age & srvvrs ben (DE,EE,MT,SI,UK: Adj)" ; 
...
label variable HY040G "Income from rental of a property or land (gross; DE, MT, SI: Top & bottom cod)" ;
...
label variable HY052G "Family/children-related allowances (contributory & nn means-tstd, MT: T & b cod)";
label variable HY052G_F "Flag";
label variable HY053G  "Family/children-related allowances (non-cntribtry & means-tested, MT: T & b cod)";
label variable HY053G_F "Flag";
label variable HY054G "Family/children-related allowance (n.-cntrbtry & n. means-tstd, MT: T & b cod)";
...
label variable HY063G  "Social exclusion not elsewhere class. (n-cntribtry & means-tstd, MT: T & b cod)";
...
label variable HY080G "Regular inter-household cash transfer received (gross; MT, SI: Top & bottom cod)" ;
...
label variable HY090G "Intrsts, dvdnds, prft frm cptl invmnt in uncrp bsn (g;DE,EE,MT,SI,UK: T & b cod)"  ;
...
label variable HY140G "Tax on income and social contributions (gross; DE, EE, MT, UK: Top & bottom cod)" ;
...
label variable HY090N "Intrsts, dvdnds, prft frm cptl invstmnt in uncorp bsn (n;DE,MT,SI,UK: T & b cod)" ;
