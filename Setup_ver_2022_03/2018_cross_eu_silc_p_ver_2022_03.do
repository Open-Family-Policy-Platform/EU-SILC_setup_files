* 2018_cross_eu_silc_p_ver_2022_03.do 
*
...
* 
* EU-SILC Cross 2018 - release 2022-03 / DOI: TBD 
*
* When publishing statistics derived from the EU-SILC UDB, please state as source:
* "EU-SILC <Type> UDB <yyyy> - version of 2022-03"
*
* Personal data file:
...
*
* Pforr, Klaus and Johanna Jung (2022): 2018_cross_eu_silc_p_ver_2022_03.do.
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO RS SE SI SK UK { ;
      cd "$csv_path/`CC'/2018" ;	
	  import delimited using "UDB_c`CC'18P.csv", case(upper) asdouble clear ;
...
label variable PE020 "ISCED level currently attended (T cod 50 & above; DE, IT, MT, SI: spec. rules)" ;
...
label variable PE040 "Highest ISCED level attained (Top coding 500 and above; IE, IT, SI: spec. rules)" ;
...
label variable PL075 "No. of months spent at fll-tme work as slfemplyd (inc family worker) (MT: T cod)" ;
label variable PL075_F "Flag" ;
label variable PL076 "Number of months spent at part-time work as self-employed (inc family worker)" ;
...
label variable PY035G "Contributions to individual private pension plans (gross, MT, SI: T & b cod)" ;
label variable PY035G_F "Flag" ;
label variable PY035G_I "Imputation factor" ;
label variable PY050G "Cash benefits or losses from self-employment (gross, DE, MT, SI: T & b cod)" ;
...
label variable PY144G "Education-related allowances (non-contributory & non means-tested, SI: Adj)";
...
label variable PW160T "Satisfaction with your personal relationships with fmily, frnds, neighbrhd & oth";
