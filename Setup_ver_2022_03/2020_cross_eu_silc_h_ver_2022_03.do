* 2020_cross_eu_silc_h_ver_2022_03.do 
*
...
*
* Pforr, Klaus and Johanna Jung (2022): 2020_cross_eu_silc_h_ver_2022_03.do.
...
foreach CC in AT BE BG CH CY CZ DK EE EL ES FI FR HR HU IE LT LU LV MT NL NO PL PT RO RS SE SI SK { ;
      cd "$csv_path/`CC'/2020" ;
	  if "`CC'"!="LT"  {;
		import delimited using "UDB_c`CC'20H.csv", case(upper) asdouble clear stringcols(124 132 140);
	  };
	  if "`CC'"=="LT"  {;
		import delimited using "UDB_cLT20H9.csv", case(upper) asdouble clear stringcols(124 132 140);	  	
	  };
...
label variable HY040G "Income from rental of a property or land (gross; DE, SI: T cod; MT: T & b cod)" ;
...
label variable HY090G "Intrsts, dvdnds, prft fr cptl invmnt in uncrpbsn (g;DE,SI: T cod;MT,UK: T&b cod)"  ;
...
label variable HY090N "Intrsts, dvdnds, prft fr cptl invmnt in uncp bsn (n;DE: T cod;MT,SI,UK: T&b cod)" ;
