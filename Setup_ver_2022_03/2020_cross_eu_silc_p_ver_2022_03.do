* 2020_cross_eu_silc_p_ver_2022_03.do 
*
...
* 
* EU-SILC Cross 2020 - release 2022-03 / DOI: TBD
*
...
*
* Pforr, Klaus and Johanna Jung (2022): 2020_cross_eu_silc_p_ver_2022_03.do.
...
label variable PY050G "Cash benefits or losses from self-employment (gr, SI: T cod; DE, MT: T & b cod)" ;
...
label variable PY091G "Unemployment benefits (contributory and means-tested, DE: Adj; MT: T & b cod)";
label variable PY091G_F "Flag";
label variable PY092G "Unemployment benefits (contributory and means-tested, DE: Adj; MT: T & b cod)";
label variable PY092G_F "Flag";
label variable PY093G "Unemployment benefits (contributory and means-tested, DE: Adj; MT: T & b cod)";
...
label variable PY102G "Old-age benefits (contributory and non means-tested, DE, SI: Adj; MT: T & b cod)";
...
label variable PY050N "Cash benefits or losses from self-employment (net, SI: Top cod; DE: T & b cod)" ;
...
;
label define PL250_VALUE_LABELS
1 "January"
2 "February"
3 "March"
4 "April"
...
label values PL250 PL250_VALUE_LABELS ;
