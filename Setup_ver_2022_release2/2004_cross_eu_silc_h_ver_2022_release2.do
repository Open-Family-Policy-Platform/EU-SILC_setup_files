* 2004_cross_eu_silc_h_ver_2022_release2.do 
*
...
* Country files are delivered in the format UDB_c*country_stub*04H.csv
* 
* (c) GESIS 2023-02-01
*
* PLEASE NOTE
...
*
* Pforr, Klaus and Johanna Jung (2023): 2004_cross_eu_silc_h_ver_2022_release2.do.
...
local log_file "$log/eusilc_2004_h" ;
...
local stata_file "$log/eusilc_2004_h_cs" ;
...
foreach CC in AT BE DK EE EL ES FI FR IE IS IT LU NO PT SE { ;
	...
	import delimited using "UDB_c`CC'04H.csv", case(upper) asdouble clear ;
...
label variable HY022 "Tt disp. Hhld Inc. bef. social trnsf. other than old-age and survivors benefits" ;
label variable HY022_F "Flag" ;
label variable HY022_I "Imputation Factor" ;
label variable HY023 "Tt disp. Hhld inc. bef. social trnsfers including old-age and survivors benefits" ;
