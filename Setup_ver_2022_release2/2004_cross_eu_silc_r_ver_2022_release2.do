* 2004_cross_eu_silc_r_ver_2022_release2.do 
*
...
* Country files are delivered in the format UDB_c*country_stub*04R.csv
* 
* (c) GESIS 2023-02-01
*
* PLEASE NOTE
...
*
* Pforr, Klaus and Johanna Jung (2023): 2004_cross_eu_silc_r_ver_2022_release2.do.
...
local log_file "$log/eusilc_2004_r" ;
...
local stata_file "$log/eusilc_2004_r_cs" ;
...
foreach CC in AT BE DK EE EL ES FI FR IE IS IT LU NO PT SE { ;
	...
	import delimited using "UDB_c`CC'04R.csv", case(upper) asdouble clear ;
...
label define RB240_F_VALUE_LABELS            
       1 "filled"      
      -1 "missing" 
      -2 "na(spouse/partner is not a household member)"
      ;  
...
label data "Personal register file 2004" ;
