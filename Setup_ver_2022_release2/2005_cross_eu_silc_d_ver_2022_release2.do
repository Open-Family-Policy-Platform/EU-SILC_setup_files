* 2005_cross_eu_silc_d_ver_2022_release2.do
*
...
*
* Pforr, Klaus and Johanna Jung (2023): 2005_cross_eu_silc_d_ver_2022_release2.do.
...
foreach CC in AT BE CY CZ DE DK EE EL ES FI FR HU IE IS IT LT LU LV NL NO PL PT SE SI SK UK { ;
	...
	import delimited using "UDB_c`CC'05D.csv", case(upper) asdouble clear ;
