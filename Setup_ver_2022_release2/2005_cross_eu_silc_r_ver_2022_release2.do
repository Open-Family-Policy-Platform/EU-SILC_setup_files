* 2005_cross_eu_silc_r_ver_2022_release2.do 
*
...
* Country files are delivered in the format UDB_c*country_stub*05R.csv
* 
* (c) GESIS 2023-02-01
*
* PLEASE NOTE
...
*
* Pforr, Klaus and Johanna Jung (2023): 2005_cross_eu_silc_r_ver_2022_release2.do.
...
local log_file "$log/eusilc_2005_r" ;
...
local stata_file "$log/eusilc_2005_r_cs" ;
...
foreach CC in AT BE CY CZ DE DK EE EL ES FI FR HU IE IS IT LT LU LV NL NO PL PT SE SI SK UK { ;
	...
	import delimited using "UDB_c`CC'05R.csv", case(upper) asdouble clear ;
...
label data "Personal register file 2005" ;
