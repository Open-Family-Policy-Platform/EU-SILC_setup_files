* 2006_cross_eu_silc_h_ver_2022_release2.do 
*
...
* Country files are delivered in the format UDB_c*country_stub*06H.csv
* 
* (c) GESIS 2023-02-01
*
* PLEASE NOTE
...
*
* Pforr, Klaus and Johanna Jung (2023): 2006_cross_eu_silc_h_ver_2022_release2.do.
...
foreach CC in AT BE CY CZ DE DK EE EL ES FI FR HU IE IS IT LT LU LV NL NO PL PT SE SI SK UK { ;
	...
	import delimited using "UDB_c`CC'06H.csv", case(upper) asdouble clear ;
