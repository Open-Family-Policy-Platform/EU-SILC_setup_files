* 2006_cross_eu_silc_r_ver_2022_release2.do 
*
...
* Country files are delivered in the format UDB_c*country_stub*06R.csv
* 
* (c) GESIS 2023-02-01
*
* PLEASE NOTE
...
*
* Pforr, Klaus and Johanna Jung (2023): 2006_cross_eu_silc_r_ver_2022_release2.do.
...
local log_file "$log/eusilc_2006_r" ;
...
local stata_file "$log/eusilc_2006_r_cs" ;
...
foreach CC in AT BE CY CZ DE DK EE EL ES FI FR HU IE IS IT LT LU LV NL NO PL PT SE SI SK UK { ;
	...
	import delimited using "UDB_c`CC'06r.csv", case(upper) asdouble clear ;
...
label variable RX040 "Work intensity (only PT)"  ;
...
label data "Personal register file 2006" ;
