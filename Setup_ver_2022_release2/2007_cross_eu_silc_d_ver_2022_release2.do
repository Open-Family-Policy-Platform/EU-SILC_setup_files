* 2007_cross_eu_silc_d_ver_2022_release2.do 
*
...
*
* Pforr, Klaus and Johanna Jung (2023): 2007_cross_eu_silc_d_ver_2022_release2.do.
...
local log_file "$log/eusilc_2007_d" ;
...
local stata_file "$log/eusilc_2007_d_cs" ;
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HU IE IS IT LT LU LV MT NL NO PL PT RO SE SI SK UK { ;
	...
	import delimited using "UDB_c`CC'07D.csv", case(upper) asdouble clear ;
...
label data "Household register file 2007" ;
