* 2007_cross_eu_silc_h_ver_2022_release2.do 
*
...
* Country files are delivered in the format UDB_c*country_stub*07H.csv
* 
* (c) GESIS 2023-02-01
*
* PLEASE NOTE
...
*
* Pforr, Klaus and Johanna Jung (2023): 2007_cross_eu_silc_h_ver_2022_release2.do.
...
local log_file "$log/eusilc_2007_h" ;
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HU IE IS IT LT LU LV MT NL NO PL PT RO SE SI SK UK { ;
	...
	import delimited using "UDB_c`CC'07H.csv", case(upper) asdouble clear ;
...
label variable MH030 "Adequate plumbing/water installations" ;
