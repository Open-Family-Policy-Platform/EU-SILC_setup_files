* 2007_cross_eu_silc_p_ver_2022_release2.do 
*
...
* 
* EU-SILC Cross 2007 - release 2022-release2 / DOI: TBD
*
...
* Country files are delivered in the format UDB_c*country_stub*07P.csv
* 
* (c) GESIS 2023-02-01
*
* PLEASE NOTE
...
*
* Pforr, Klaus and Johanna Jung (2023): 2007_cross_eu_silc_p_ver_2022_release2.do.
...
local log_file "$log/eusilc_2007_p" ;
...
local stata_file "$log/eusilc_2007_p_cs" ;
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HU IE IS IT LT LU LV MT NL NO PL PT RO SE SI SK UK { ;
	...
	import delimited using "UDB_c`CC'07P.csv", case(preserve) asdouble clear ;
...
drop lastup lasttime C_BIRTH CIT_SHIP res_wgt ppp ;
...
label define PB180_F_VALUE_LABELS              
            1 "filled"
           -1 "missing"
           -2 "not applicable (person has no spouse partner or spouse partner is not a hhld member)"
            ;
...
label data "Personal data file 2007" ;
