* 2008_cross_eu_silc_h_ver_2022_release2.do
*
...
* Country files are delivered in the format UDB_c*country_stub*08H.csv
* 
* (c) GESIS 2023-02-01
*
* PLEASE NOTE
...
*
* Pforr, Klaus and Johanna Jung (2023): 2008_cross_eu_silc_h_ver_2022_release2.do.
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HU IE IS IT LT LU LV MT NL NO PL PT RO SE SI SK UK { ;
      cd "$csv_path/`CC'/2008" ;
	  import delimited using "UDB_c`CC'08H.csv", case(upper) asdouble clear;
...
label variable HS070 "Do you have a telephone (incl mobile phone)?" ;
...
label variable MI030 "Household has credit card(s) and/or store card(s)" ;
label variable MI030_F "Flag" ;
label variable MI040 "Household has credit card(s) and/or store card(s) with un-cleared balances" ;
label variable MI040_F "Flag" ;
label variable MI045 "Est tt amnt unbal. at lst mnthly statement on hhld creditstore cards in classes" ;
label variable MI045_F "Flag" ;
label variable MI046 "Tt amnt unbal. at lst mnthly sttmnt on hhld crdtstr crds (exct amnts) (OPTIONAL)" ;
...
label variable MI053 "Household has home-related credit/loans (inventory, domestic appl, repairs)" ;
label variable MI053_F "Flag" ;
label variable MI054 "Household has credit/loans to pay for holidays/leisure" ;
...
label variable MI058 "Hhld has oth cash loans (dbt cnvrsn, to cver ovrdrft, crdt crd & oth. blls, etc)" ;
label variable MI058_F "Flag" ;
label variable MI060 "Arrears on other non-housing household bills" ;
label variable MI060_F "Flag" ;
label variable MI065 "Estim. tt amount crrntly in arrears for other non-housing hhld bills in classes" ;
label variable MI065_F "Flag" ;
label variable MI066 "Tt amnt crrntly in area. for oth non-housing hhld blls (exct amnts) (OPTIONAL)" ;
label variable MI066_F "Flag" ;
label variable MI075 "Estim. tt amount crrntly in arrears for hhld housing bill, repayments in classes" ;
label variable MI075_F "Flag" ;
label variable MI076 "Tt amnt crrntly in area. for oth non-housing hhld blls (exct amnts) (OPTIONAL)" ;
label variable MI076_F "Flag" ;
label variable MI085 "Est. tt amnt crrntly in area. for hhld oth loans & credit repayment in classes" ;
label variable MI085_F "Flag" ;
label variable MI086 "Tt amnt crrntly in area. f hhld oth loans & crdt repymnt (exct amnts) (OPTIONAL)" ;
...
label variable MI100 "Expect. of financ. Situ. in nxt 12 mnths; do you expect your financial situation" ;
