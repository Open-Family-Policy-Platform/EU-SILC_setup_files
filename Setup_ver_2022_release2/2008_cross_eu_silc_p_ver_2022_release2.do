* 2008_cross_eu_silc_p_ver_2022_release2.do 
*
...
* Country files are delivered in the format UDB_c*country_stub*08P.csv
* 
* (c) GESIS 2023-02-01
*
* PLEASE NOTE
...
*
* Pforr, Klaus and Johanna Jung (2023): 2008_cross_eu_silc_p_ver_2022_release2.do.
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HU IE IS IT LT LU LV MT NL NO PL PT RO SE SI SK UK { ;
      cd "$csv_path/`CC'/2008" ;	
	  import delimited using "UDB_c`CC'08P.csv", case(upper) asdouble clear;
...
label variable PX020 "Age at the end of the income reference period (MT grouped)" ;
...
label variable PL110 "NACE (Rev 1.1) (Missing: AT, BG)" ;
label variable PL111 "NACE (Rev 2) (Missing: AT, BG)" ;
