* 2009_cross_eu_silc_d_ver_2022_release2.do 
*
...
* 
* EU-SILC Cross 2009 - release 2022-release2 / DOI: TBD
*
...
*
* Pforr, Klaus and Johanna Jung (2023): 2009_cross_eu_silc_d_ver_2022_release2.do.
...
local log_file "$log/eusilc_2009_d" ;
...
local stata_file "$log/eusilc_2009_d_cs" ;
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HU IE IS IT LT LU LV MT NL NO PL PT RO SE SI SK UK { ;
      cd "$csv_path/`CC'/2009" ;
	  import delimited using "UDB_c`CC'09D.csv", case(upper) asdouble clear ;
...
label data "Household register file 2009" ;
