* 2009_cross_eu_silc_r_ver_2022_release2.do 
*
...
* Country files are delivered in the format UDB_l*country_stub*09R.csv
* 
* (c) GESIS 2023-02-01
* 
* PLEASE NOTE
...
*
* Pforr, Klaus and Johanna Jung (2023): 2009_cross_eu_silc_r_ver_2022_release2.do.
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HU IE IS IT LT LU LV MT NL NO PL PT RO SE SI SK UK { ;
      cd "$csv_path/`CC'/2009" ;
	   import delimited using "UDB_c`CC'09R.csv", case(upper) asdouble clear ;
