* 2010_cross_eu_silc_d_ver_2022_release2.do 
*
...
* 
* EU-SILC Cross 2010 - release 2022-release2 / DOI: TBD
*
...
* L-2010 DIFFERENCES BETWEEN DATA COLLECTED.doc	
* 
...
*
* Pforr, Klaus and Johanna Jung (2023): 2010_cross_eu_silc_d_ver_2022_release2.do.
...
local log_file "$log/eusilc_2010_d" ;
...
local stata_file "$log/eusilc_2010_d_cs" ;
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO SE SI SK UK { ;
      cd "$csv_path/`CC'/2010" ;		
	   import delimited using "UDB_c`CC'10D.csv", case(upper) asdouble clear ;
...
label data "Household register file 2010" ;
