* 2010_cross_eu_silc_r_ver_2022_release2.do 
*
...
* Country files are delivered in the format UDB_l*country_stub*10R.csv
* 
* (c) GESIS 2023-02-01
* 
* PLEASE NOTE
...
*
* Pforr, Klaus and Johanna Jung (2023): 2010_cross_eu_silc_r_ver_2022_release2.do.
...
local log_file "$log/eusilc_2010_r" ;
...
local stata_file "$log/eusilc_2010_r_cs" ;
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO SE SI SK UK { ;
      cd "$csv_path/`CC'/2010" ;
	   import delimited using "UDB_c`CC'10R.csv", case(upper) asdouble clear ;
...
label data "Personal register file 2010" ;
