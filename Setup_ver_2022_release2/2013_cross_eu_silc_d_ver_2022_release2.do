* 2013_cross_eu_silc_d_ver_2022_release2.do 
*
...
* 
* EU-SILC Cross 2013 - release 2022-release2 / DOI: TBD
*
...
* Country files are delivered in the format UDB_l*country_stub*13D.csv
* 
* (c) GESIS 2023-02-01
* 
* PLEASE NOTE
...
*
* Pforr, Klaus and Johanna Jung (2023): 2013_cross_eu_silc_d_ver_2022_release2.do.
...
local log_file "$log/eusilc_2013_d" ;
...
local stata_file "$log/eusilc_2013_d_cs" ;
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO RS SE SI SK UK { ;
      cd "$csv_path/`CC'/2013" ;		
	   import delimited using "UDB_c`CC'13D.csv", case(upper) asdouble clear ;
...
label variable DB100 "Degree of urbanisation (EE, V:1,2 = 1; MT:2,3 = 2)" ;
...
label define DB070_F_VALUE_LABELS            
 1 "filled"
-2 "not applicable"
12 "order on sampl.frame is fixed for all EU-SILC survey years; PSUs have unequal probability of selection (within explicit strata)"
...
label data "Household register file 2013" ;
