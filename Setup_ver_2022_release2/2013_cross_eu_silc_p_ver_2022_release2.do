* 2013_cross_eu_silc_p_ver_2022_release2.do 
*
...
* Country files are delivered in the format UDB_l*country_stub*13P.csv
* 
* (c) GESIS 2023-02-01
* 
* PLEASE NOTE
...
*
* Pforr, Klaus and Johanna Jung (2023): 2013_cross_eu_silc_p_ver_2022_release2.do.
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO RS SE SI SK UK { ;
      cd "$csv_path/`CC'/2013" ;	
	   import delimited using "UDB_c`CC'13P.csv", case(upper) asdouble clear ;
