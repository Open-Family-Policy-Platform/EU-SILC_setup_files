* 2014_cross_eu_silc_h_ver_2022_release2.do 
*
...
* 
* EU-SILC Cross 2014 - release 2022-release2 / DOI: TBD
*
...
*
* Pforr, Klaus and Johanna Jung (2023): 2014_cross_eu_silc_h_ver_2022_release2.do.
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO RS SE SI SK UK { ;
      cd "$csv_path/`CC'/2014" ;
	  import delimited using "UDB_c`CC'14H.csv", case(upper) asdouble clear ;
...
label variable HD120 "Fruit and vegetables once a day (prtlly dffrs frm 2009 module variable HD120)";
label variable HD120_F "Flag";
label variable HD140 "One meal with meat, chicken or fish (or vegetarian equiv.) at least once a day";
...
label variable HD170 "Indoor games (educational baby toys, building blocks, board gms, cmptrgms, etc.)";
