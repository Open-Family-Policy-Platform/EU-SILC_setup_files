* 2015_cross_eu_silc_p_ver_2022_release2.do 
*
...
* 
* EU-SILC Cross 2015 - release 2022-release2 / DOI: TBD
*
...
* Country files are delivered in the format UDB_l*country_stub*15P.csv
* 
* (c) GESIS 2023-02-01
* 
* PLEASE NOTE
...
*
* Pforr, Klaus and Johanna Jung (2023): 2015_cross_eu_silc_p_ver_2022_release2.do.
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO RS SE SI SK UK { ;
      cd "$csv_path/`CC'/2015" ;	
	  import delimited using "UDB_c`CC'15P.csv", case(upper) asdouble clear ;
...
label variable PE020 "ISCED level currently attended (T Cod 50 & above; DE, IT, MT, SI: specif. rules)" ;
...
label variable PE040 "Highest ISCED level attained (Top Coding 500 & above; IE, IT, SI: specif. rules)" ;
...
label variable PY031G "Optional employer social insurance contributions (gross; in Euros, SI: Top cod.)" ;
...
label variable PY050G "Cash benefits or losses from self-employment (gross, DE, SI: Top & bottom cod.)" ;
