* 2016_cross_eu_silc_h_ver_2022_release2.do 
*
...
* 
* EU-SILC Cross 2016 - release 2022-release2 / DOI: TBD
*
...
* Country files are delivered in the format UDB_l*country_stub*16H.csv
* 
* (c) GESIS 2023-02-01
* 
* PLEASE NOTE
...
*
* Pforr, Klaus and Johanna Jung (2023): 2016_cross_eu_silc_h_ver_2022_release2.do.
...
local log_file "$log/eusilc_2016_h" ;
...
local stata_file "$log/eusilc_2016_h_cs" ;
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE IS IT LT LU LV MT NL NO PL PT RO RS SE SI SK UK { ;
      cd "$csv_path/`CC'/2016" ;		
	  import delimited using "UDB_c`CC'16H.csv", case(upper) asdouble clear ;
	  * In some countries some non-numeric characters are wrongfully included.
...
* Please note: Variables HC040, HC050, HC060, HC100, HC160 have been changed and assigned new content.
* To differentiate between content of 2012 and 2016, the variables are marked with a year 2016 suffix. ;
* In 2012 HC040 was "Adequate plumbing/water installations" ;
* In 2012 HC050 was "Dwelling equipped with heating facilities" ;
* In 2012 HC060 was "Dwelling comfortably warm during winter time" ;
* In 2012 HC100 was "Accessibility of banking services" ;
* In 2012 HC160 was "Main reason for the expectation to be forced to leave the dwelling" ;

rename (HC040 HC050 HC060 HC100 HC160) (HC040_2016 HC050_2016 HC060_2016 HC100_2016 HC160_2016) ;
rename (HC040_F HC050_F HC060_F HC100_F HC160_F) (HC040_2016_F HC050_2016_F HC060_2016_F HC100_2016_F HC160_2016_F) ;
...
label variable HY023 "Tt disp hhld inc bef soc trnsfrs inc old-age & srvvrs bens (DE, EE, SI, UK: Adj)" ; 
...
label variable HY090G "Intrsts, dvdnds, prft frm cptl invstmnt in uncrp bsn (gr; DE, EE, SI, UK: T cod)"  ;
...
label variable HY090N "Intersts, dividnds, proft frm cptl invstmnt in uncorp busin (net; DE, SI: T cod)" ;
...
*Ad-hoc module on health care ;
label variable HC040_2016 "Affordability of childcare services" ; 
label variable HC040_2016_F	"Flag" ;
label variable HC050_2016 "Unmet needs for formal childcare services" ;
label variable HC050_2016_F	"Flag" ;
label variable HC060_2016 "Main reason for not making (more) use of formal childcare services" ;
label variable HC060_2016_F	"Flag" ;
label variable HC100_2016 "Affordability of formal education" ;
label variable HC100_2016_F	"Flag" ;
label variable HC160_2016 "Use of health care services" ;
label variable HC160_2016_F	"Flag" ;
label variable HC170	"Payment for health care services" ;
label variable HC170_F	"Flag" ;
label variable HC180	"Affordability of health care services" ;
label variable HC180_F	"Flag" ;
label variable HC190	"Prsnc in hhld of ppl wh need hlp bc lng-trm physcl/mntl ill-hlth, infrmty/oldage" ;
label variable HC190_F	"Flag" ;
label variable HC200	"Professional home care received" ;
label variable HC200_F	"Flag" ;
label variable HC210	"Number of hours per week of professional home care received (DE: missing)" ;
label variable HC210_F	"Flag" ;
label variable HC220	"Payment for professional home care" ;
label variable HC220_F	"Flag" ;
label variable HC230	"Affordability of professional home care services" ;
label variable HC230_F	"Flag" ;
label variable HC240	"Unmet needs for professional home care" ;
label variable HC240_F	"Flag" ;
label variable HC250	"Main reason for not receiving (more) professional home care services" ;
label variable HC250_F	"Flag" ;
...
label define HH031_VALUE_LABELS       
 1961 "PT: 1961 and earlier"
 1945 "SI: 1945 and earlier"
;
...
label define HC040_2016_VALUE_LABELS  
 1 "With great difficulty"
 2 "With difficulty"
 3 "With some difficulty"
 4 "Fairly easily"
 ...
 6 "Very easily"    
;
label define HC040_2016_F_VALUE_LABELS  
 1 "Filled"
 -1 "Missing"
 -4 "No costs of childcare in the household"
 -5 "No children aged 0-12 in the household"
 -7 "Not applicable HB010 ≠ 2016"
;
label define HC050_2016_VALUE_LABELS  
 1 "Yes"
 2 "No"
;
label define HC050_2016_F_VALUE_LABELS  
 1 "Filled"
 -1 "Missing"
 -5 "No children aged 0-12 in the household"
 -7 "Not applicable HB010 ≠ 2016"
;
label define HC060_2016_VALUE_LABELS  
 1 "Cannot afford it"
 2 "No places available"
 3 "Places available but not nearby"
 4 "Places available but opening hours not suitable"
 5 "Places available but the quality of the services available not satisfactory"
 6 "Other reasons"
;
label define HC060_2016_F_VALUE_LABELS  
 1 "Filled"
 -1 "Missing"
 ...
 -7 "Not applicable HB010 ≠ 2016"
;
label define HC100_2016_VALUE_LABELS  
 1 "With great difficulty"
 2 "With difficulty"
 3 "With some difficulty"
 4 "Fairly easily"
 ...
 6 "Very easily" 
;
label define HC100_2016_F_VALUE_LABELS  
 1 "Filled"
 -1 "Missing"
 ...
 -7 "Not applicable HB010 ≠ 2016"
;
label define HC160_2016_VALUE_LABELS  
 1 "Yes"
 2 "No"
;
label define HC160_2016_F_VALUE_LABELS  
 1 "Filled"
 -1 "Missing"
 -7 "Not applicable HB010 ≠ 2016"
;
label define HC170_VALUE_LABELS  
 1 "Yes"
 2 "No"
;
label define HC170_F_VALUE_LABELS  
 1 "Filled"
 -1 "Missing"
 -2 "Not applicable (HC060 = 2)"
 -7 "Not applicable HB010 ≠ 2016"
;
label define HC180_VALUE_LABELS  
 1 "With great difficulty"
 2 "With difficulty"
 3 "With some difficulty"
 4 "Fairly easily"
 ...
 6 "Very easily" 
;
label define HC180_F_VALUE_LABELS  
 1 "Filled"
 -1 "Missing"
 -2 "Not applicable (HC160 = 2)"
 -7 "Not applicable HB010 ≠ 2016"
;
label define HC190_VALUE_LABELS  
 1 "Yes"
 2 "No"
;
label define HC190_F_VALUE_LABELS  
 1 "Filled"
 -1 "Missing"
 -7 "Not applicable HB010 ≠ 2016"
;
label define HC200_VALUE_LABELS  
 1 "Yes"
 2 "No"
;
label define HC200_F_VALUE_LABELS  
 1 "Filled"
 -1 "Missing"
 -2 "Not applicable (HC190 = 2)"
 -7 "Not applicable HB010 ≠ 2016"
;
label define HC210_VALUE_LABELS  
 1 "Less than 10 hours per week"
 2 "At least 10 but less than 20 hours per week"
 3 "20 hours per week or more"
;
label define HC210_F_VALUE_LABELS  
 1 "Filled"
 -1 "Missing"
 -2 "Not applicable (HC190=2 or HC200=2)"
 -7 "Not applicable HB010 ≠ 2016"
;
label define HC220_VALUE_LABELS  
 1 "Yes"
 2 "No"
;
label define HC220_F_VALUE_LABELS  
 1 "Filled"
 -1 "Missing"
 -2 "Not applicable (HC190=2 or HC200=2)"
 -7 "Not applicable HB010 ≠ 2016"
;
label define HC230_VALUE_LABELS  
 1 "With great difficulty"
 2 "With difficulty"
 3 "With some difficulty"
 4 "Fairly easily"
 ...
 6 "Very easily" 
;
label define HC230_F_VALUE_LABELS  
 1 "Filled"
 -1 "Missing"
 -2 "Not applicable (HC190=2 or HC200=2 or HC220=2)"
 -7 "Not applicable HB010 ≠ 2016"
;
label define HC240_VALUE_LABELS  
 1 "Yes"
 2 "No"
;
label define HC240_F_VALUE_LABELS  
 1 "Filled"
 -1 "Missing"
 -2 "Not applicable (HC190=2)"
 -7 "Not applicable HB010 ≠ 2016"
;
label define HC250_VALUE_LABELS  
 1 "Cannot afford it"
 ...
 5 "Other reasons"
;
label define HC250_F_VALUE_LABELS  
 1 "Filled"
 -1 "Missing"
...
*Ad-hoc module on health care ;
label values HC040_2016 HC040_2016_VALUE_LABELS ;
label values HC040_2016_F HC040_2016_F_VALUE_LABELS ;
label values HC050_2016 HC050_2016_VALUE_LABELS ;
label values HC050_2016_F HC050_2016_F_VALUE_LABELS ;
label values HC060_2016 HC060_2016_VALUE_LABELS ;
label values HC060_2016_F HC060_2016_F_VALUE_LABELS ;
label values HC100_2016 HC100_2016_VALUE_LABELS ;
label values HC100_2016_F HC100_2016_F_VALUE_LABELS ;
label values HC160_2016 HC160_2016_VALUE_LABELS ;
label values HC160_2016_F HC160_2016_F_VALUE_LABELS ;
label values HC170 HC170_VALUE_LABELS ;
label values HC170_F HC170_F_VALUE_LABELS ;
label values HC180 HC180_VALUE_LABELS ;
label values HC180_F HC180_F_VALUE_LABELS ;
label values HC190 HC190_VALUE_LABELS ;
label values HC190_F HC190_F_VALUE_LABELS ;
label values HC200 HC200_VALUE_LABELS ;
label values HC200_F HC200_F_VALUE_LABELS ;
label values HC210 HC210_VALUE_LABELS ;
label values HC210_F HC210_F_VALUE_LABELS ;
label values HC220 HC220_VALUE_LABELS ;
label values HC220_F HC220_F_VALUE_LABELS ;
label values HC230 HC230_VALUE_LABELS ;
label values HC230_F HC230_F_VALUE_LABELS ;
label values HC240 HC240_VALUE_LABELS ;
label values HC240_F HC240_F_VALUE_LABELS ;
label values HC250 HC250_VALUE_LABELS ;
label values HC250_F HC250_F_VALUE_LABELS ;

label data "Household data file 2016" ;
