* 2019_cross_eu_silc_d_ver_2022_release2.do 
*
...
*
* Pforr, Klaus and Johanna Jung (2023): 2019_cross_eu_silc_d_ver_2022_release2.do.
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE /*IS*/ IT LT LU LV MT NL NO PL PT RO RS SE SI SK /*UK*/ { ;
      cd "$csv_path/`CC'/2019" ;		
	  import delimited using "UDB_c`CC'19D.csv", case(upper) asdouble clear ;
