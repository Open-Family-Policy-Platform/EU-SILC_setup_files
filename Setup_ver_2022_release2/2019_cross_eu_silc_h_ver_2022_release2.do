* 2019_cross_eu_silc_h_ver_2022_release2.do 
*
...
*
* Pforr, Klaus and Johanna Jung (2023): 2019_cross_eu_silc_h_ver_2022_release2.do.
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE /*IS*/ IT LT LU LV MT NL NO PL PT RO RS SE SI SK /*UK*/ { ;
      cd "$csv_path/`CC'/2019" ;		
	  import delimited using "UDB_c`CC'19H.csv", case(upper) asdouble clear ;
...
label variable HS050 "Capacity to afford meal with meat, chicken, fish (or veg. equiv.) ev.  sec. day" ;
...
label variable HY022 "Tt dsp hh inc bf soc tr ex benf (DE EE MT SI UK: adj; MT: t & b cod)" ; 
label variable HY022_F "Flag" ;
label variable HY022_I "Imputation factor" ;
label variable HY023 "Tt dsp hh inc bf soc tr w/ benf (DE EE MT SI UK: adj; MT: t & b cod)" ; 
...
label variable HY040G "Inc. from rental of a property or land (gr.; DE, SI: T. cod.; MT: T. & b. cod.)" ;
label variable HY040G_F "Flag" ;
label variable HY040G_I "Imputation factor" ;
label variable HY050G  "Family/Children-related allowances (gross; SI: T. cod.; MT: T. & b. cod.)" ;
...
label variable HY052G "Family/Children-related allow. (contrib. a. n. means-tested, MT: T. & b. cod.)";
label variable HY052G_F "Flag";
label variable HY053G  "Family/Children-related allow. (n.-contrib. a. means-tested, MT: T. & b. cod.)";
label variable HY053G_F "Flag";
label variable HY054G "Family/Child.-related allow. (n.-contrib. a. n. means-tested, MT: T. & b. cod.)";
label variable HY054G_F "Flag";
label variable HY060G  "Social exclusion not elsewhere classified (gross; SI: T. cod.; MT: T. & b. cod.)" ;
...
label variable HY063G  "Social exclusion n. elswh class. (n.-contrib. a. means-tested, MT: T. & b. cod.)";
label variable HY063G_F "Flag";
label variable HY064G  "Social exclusion not elsewhere classified (non-contributory a. n. means-tested)";
...
label variable HY073G  "Housing allowances (non-contrib. a. means-tested, MT: T. & b. cod.; MT: Adj.)";
...
label variable HY080G "Regular interhhld cash transfer received (gr.; SI: T. cod., MT: T. & b. cod.)" ;
...
label variable HY090G "Intsts, divid, prft frm capi inv in ucorp bsn (gr; DE, EE, MT SI, UK: T & b cod)"  ;
...
label variable HY110G "Income received by people aged under 16 (gross; SI: T. cod., MT: T. & b. cod.)" ;
...
label variable HY140G "Tax on inc. and soc. contrib. (gr.; UK: T. cod.; DE, MT: T. & b. cod.; MT: Adj.)" ;
...
label variable HY090N "Intsts, divid, profit frm capi inv in uncorp busin (n; DE, MT SI, UK: T & b cod)" ;
