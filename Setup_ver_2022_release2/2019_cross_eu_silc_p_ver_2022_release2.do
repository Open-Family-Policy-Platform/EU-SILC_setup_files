* 2019_cross_eu_silc_p_ver_2022_release2.do 
*
...
* 
* EU-SILC Cross 2019 - release 2022-release2 / DOI: TBD
*
...
*
* Pforr, Klaus and Johanna Jung (2023): 2019_cross_eu_silc_p_ver_2022_release2.do.
...
foreach CC in AT BE BG CH CY CZ DE DK EE EL ES FI FR HR HU IE /*IS*/ IT LT LU LV MT NL NO PL PT RO RS SE SI SK /*UK*/ { ;
      cd "$csv_path/`CC'/2019" ;	
	  import delimited using "UDB_c`CC'19P.csv", case(upper) asdouble clear ;
...
label variable PD050 "Get-together w. friends/family (relatives) for a drink/meal at least once/month";
...
label variable PE020 "ISCED level currently att. (T. cod. 50 a. abv; DE, IT, MT, SI: specif. rules)" ;
...
label variable PE040 "Highest ISCED level attained (T. cod. 500 a. abv; IE, IT, SI: specif. rules)" ;
...
label variable PL075 "No. mon. spnt at f.-time wrk as slf-empl. (incl. fam. workr) (MT: T. & b. cod.)" ;
label variable PL075_F "Flag" ;
label variable PL076 "No. mon. spnt at p.-time wrk as slf-empl.(incl. fam. workr) (MT: T. & b. cod.)" ;
...
label variable PL086 "Number of months spent as disabled or/and unfit to work (MT: T. & b. cod.)" ;
...
label variable PL089 "Number of months spent fulfill. dom. tasks and care respons. (MT: T. & b. cod.)" ;
...
label variable PY010G "Employee cash or near cash income (gross, DE, SI: T. c.; MT: T. & b. cod.)" ;
...
label variable PY030G  "Employers social insurance contrib. (in Euros, SI: T. cod.; MT: T. & b. cod.)" ;
label variable PY030G_F "Flag" ;
label variable PY030G_I "Imputation factor" ;
label variable PY031G "Optional employer social insurance contrib. (in Euros, SI: T. cod.) (OPTIONAL)" ;
label variable PY031G_F "Flag" ;
label variable PY031G_I "Imputation factor" ;
label variable PY035G "Contrib. to indiv. private pension plans (gr., SI: T. cod.; MT: T. & b. cod.)" ;
label variable PY035G_F "Flag" ;
label variable PY035G_I "Imputation factor" ;
label variable PY050G "Cash benf. or losses from self-employm. (gr., SI: T. cod.; DE, MT: T. & b. cod.)" ;
...
label variable PY091G "Unemployment benefits (contrib. and means-tested, DE: Adj.; MT: T. & b. cod.)";
label variable PY091G_F "Flag";
label variable PY092G "Unemployment benefits (contrib. and means-tested, DE: Adj.; MT: T. & b. cod.)";
label variable PY092G_F "Flag";
label variable PY093G "Unemployment benefits (contrib. and means-tested, DE: Adj.; MT: T. & b. cod.)";
...
label variable PY102G "Old-age benefits (contrib. and non means-tested, DE, SI: Adj.; MT: T. & b. cod.)";
label variable PY102G_F "Flag";
label variable PY103G "Old-age benefits (non-contributory and means-tested, DE: Adj.; MT: T. & b. cod.)";
label variable PY103G_F "Flag";
label variable PY104G "Old-age benf. (n.-contrib. a. n. means-tested, DE, SI: Adj.; MT: T. & b. cod.)";
...
label variable PY112G "Survivor benefits (contrib. and non means-tested, SI: Adj.; MT: T. & b. cod.)";
...
label variable PY122G "Sickness benefits (contrib. and non means-tested; MT: T. & b. cod.; MT: Adj.)";
...
label variable PY132G "Disability benefits (contrib. and non means-tested, SI: Adj.; MT: T. & b. cod.)";
label variable PY132G_F "Flag";                         
label variable PY133G "Disability benefits (non-contrib. and means-tested, SI: Adj.; MT: T. & b. cod.)";
...
label variable PY144G "Educ.-relat. allow. (n.-contrib. a. n. means-tested, SI: Adj.; MT: T. & b. cod.)";
...
label variable PY050N "Cash benefits or losses from self-employm. (net, SI: T. cod.; DE: T. & b. cod.)" ;
...
label variable PX020 "Age at the end of the income reference period (DE: age group pert., MT: Adj.)" ;
...
label variable PT040 "Number of persons in the household in work when resp. was around 14 years old" ;
...
label variable PT150 "Main occupation of the father when resp. was around 14 years old (ISCO-08 (COM))" ;
...
label variable PT180 "Main occupation of the mother when resp. was around 14 years old (ISCO-08 (COM))" ;
...
label variable PT260 "Basic school needs (books & equipm. for school) met when resp. was arnd 14 y/o" ;
label variable PT260_F "Flag" ;
label variable PT270 "Hav. meal w. meat, chick., fish (or veg. equiv.) daily wh. resp. was arnd 14 y/o" ;
