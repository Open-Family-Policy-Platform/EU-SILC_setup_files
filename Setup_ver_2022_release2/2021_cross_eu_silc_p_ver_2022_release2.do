* 2021_cross_eu_silc_p_ver_2022_release2.do 
*
...
*
* Pforr, Klaus and Johanna Jung (2023): 2021_cross_eu_silc_p_ver_2022_release2.do.
...
label variable PK010 "Household member has children who are not household members";
label variable PK010_F "Flag";
label variable PK020 "Main reason for not spending more time with children who are household members";
label variable PK020_F "Flag";
label variable PK030 "Main reason for not spending more time with children who are not hh members";
label variable PK030_F "Flag";
...
label variable PE041 "Educational attainment level" ;
...
label variable PL051A "Occupation in main job" ;
label variable PL051A_F "Flag" ;
label variable PL051B "Occupation (last job)" ;
...
-7 "Not applicable (PB010 not equal to 2021)"
;
label define PK010_VALUE_LABELS
1 "Yes"
2 "No"
;
label define PK010_F_VALUE_LABELS
1 "Filled"
-1 "Missing"
-2 "Not applicable (HK020 equal to 0)"
-7 "Not applicable (PB010 not equal to 2021)"
;
label define PK020_VALUE_LABELS
1 "My work (paid work or unpaid work)"
2 "My studies"
3 "Being separated"
4 "For health reasons"
5 "Distance"
6 "Child doesn't want/has other priorities"
7 "Other reason"
8 "Nothing prevents me from spending more time with children"
;
label define PK020_F_VALUE_LABELS
1 "Filled"
-1 "Missing"
-2 "Not applicable (person does not have children 0-17 living in the household)"
-7 "Not applicable (PB010 not equal to 2021)"
;
label define PK030_VALUE_LABELS
1 "My work (paid work or unpaid work)"
2 "My studies"
3 "Being separated"
4 "For health reasons"
...
8 "Nothing prevents me from spending more time with children"
;
label define PK030_F_VALUE_LABELS
1 "Filled"
-1 "Missing"
-2 "Not applicable (PK010 not equal to 1)"
-7 "Not applicable (PB010 not equal to 2021)"
;
...
label values PK010 PK010_VALUE_LABELS ;
label values PK010_F PK010_F_VALUE_LABELS ;
label values PK020 PK020_VALUE_LABELS ;
label values PK020_F PK020_F_VALUE_LABELS ;
label values PK030 PK030_VALUE_LABELS ;
label values PK030_F PK030_F_VALUE_LABELS ;
